...
function x808237_OnImpactFadeOut( sceneId, selfId, impactId )
	...
	if GetHp( sceneId, selfId ) == 0 then		
		return		
			...
			LuaFnSendSpecificImpactToUnit( sceneId, selfId, selfId, selfId, 29582, 0 ) --không dùng dc kÛ nång
			LuaFnSendSpecificImpactToUnit( sceneId, selfId, selfId, selfId, 29583, 0 ) --mi­n d¸ch hi®u Ñng x¤u
