...
function x000550_DoAllAction(sceneId,selfId,Request,Param_1,Param_2,Param_3,Param_4,Param_5)
	...
	if Request==2 then																	--Cµng ði¬m t× nhân v§t
		...
		LuaFnWashSomePoints(sceneId,selfId,1,-Param_1)
		LuaFnWashSomePoints(sceneId,selfId,2,-Param_2)
		LuaFnWashSomePoints(sceneId,selfId,3,-Param_3)
		LuaFnWashSomePoints(sceneId,selfId,4,-Param_4)
		LuaFnWashSomePoints(sceneId,selfId,5,-Param_5)
