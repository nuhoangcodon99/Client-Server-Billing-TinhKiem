...
function x100005_OnConditionCheck( sceneId, selfId )
	...
	if itemId ~= x100005_g_ItemId then
		return 0
	end
	--end hd add
...
function x100005_OnActivateOnce( sceneId, selfId )
    local ZengDianPerAct = 1000000000
	...
	--x100005_ShowNotice( sceneId, selfId, "Các hÕ nh§n ğßşc "..(ZengDianPerAct).." #-14." )
	return 1;
end
