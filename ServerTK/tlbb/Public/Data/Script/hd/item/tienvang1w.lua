...
function x100004_OnActivateOnce( sceneId, selfId )
    ...
    --x100001_ShowNotice( sceneId, selfId, "Äú³É¹¦µÄÔö¼ÓÁË"..(ZengDianPerAct).."µãÔª±¦¡£" )
	--x100004_ShowNotice( sceneId, selfId, "Các hÕ nh§n ğßşc "..(ZengDianPerAct).." #-14." )
	return 1;
end
