...
function x805007_OnDefaultEvent( sceneId, selfId,targetId )
	...
	BeginEvent(sceneId)
		strText = "    我是武器店掌櫃，寶劍配英雄，天下名兵諸事，都可以找我，自己人嘛。"
		AddText(sceneId,strText)
		AddNumText(sceneId,x805007_g_scriptId,"神秘商店",7,8)
		AddNumText(sceneId,x805007_g_scriptId,"委託打造",6,9)
		AddNumText(sceneId,x805007_g_scriptId,"武具坊介紹",11,7)
	EndEvent(sceneId)
