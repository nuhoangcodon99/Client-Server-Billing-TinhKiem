...
x712520_g_DropTable = {
	...
	--Åëâ¿Åä·½Àà
	{
		...
		idx = {	--ÎïÆ·ĞòÁĞºÅ±í
						30303059,30303060,30303061,30303062,30304054,30304055,30304056,30304057,30304058,30304059,30304060,30304061,30304062,
					},
	},
	--ÖÆÔìÅä·½Àà
	{
...
function x712520_OnTickCreateFinish( sceneId, growPointType, tickCount )
	if(strlen(x712520_g_TickCreate_Msg) > 0) then
		...
		print( sceneId .. " Hi®u cänh "..x712520_g_TickCreate_Msg)
	end
end
