...
function	 x712004_OnOpen(sceneId,selfId,targetId)
	...
	x712004_g_FishTime = random(80000)+20000	--»ñµÃÒ»¸ö20-100ÃëÖ®¼äµÄËæ»úÊı
	--x712004_g_FishTime = random(8000)+2000	--»ñµÃÒ»¸ö2-10ÃëÖ®¼äµÄËæ»úÊı
	SetAbilityOperaTime(sceneId,selfId,x712004_g_FishTime)	--ÉèÖÃÒ»´Îµöµ½ÓãµÄÊ±¼ä
...
function	x712004_OnProcOver(sceneId,selfId,targetId)
	...
	if ret_1 > 0 then					-->0±íÊ¾ÎïÆ·³É¹¦·ÅÈë±³°üÖĞ
		Msg2Player(sceneId,selfId,"Các hÕ ğã câu ğßşc 1 con Bình Ngß",MSG2PLAYER_PARA)
		-- Ôö¼ÓÊìÁ·¶È
		ABilityID	=	GetItemBoxRequireAbilityID(sceneId,targetId)
