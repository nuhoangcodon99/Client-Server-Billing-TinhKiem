...
--½Å±¾ºÅ
 x335270_g_scriptId = 335270 --ÁÙÊ±Ð´Õâ¸ö,ÕæÕýÓÃµÄÊ±ºòÒ»¶¨Òª¸Ä.
...
--×¢£ºÁ½¸öÆïÊõ»áÒ»¸ö¾Í¿ÉÒÔÆïÁË
 x335270_g_Equitation1 = 1080 --ÐèÒªµÄÆïÊõ
 x335270_g_Equitation2 = -1 --ÐèÒªµÄÆïÊõ
--Ð§¹ûµÄID
 x335270_g_Impact1 = 5277 --ÁÙÊ±Ð´Õâ¸ö
 x335270_g_Impact2 = -1 --²»ÓÃ

--**********************************
--ÊÂ¼þ½»»¥Èë¿Ú
--**********************************
function  x335270_OnDefaultEvent( sceneId, selfId, bagIndex )
...
--**********************************
function  x335270_IsSkillLikeScript( sceneId, selfId)
...
--**********************************
function  x335270_CancelImpacts( sceneId, selfId )
	nRet = 0;
	nRet = LuaFnCancelSpecificImpact(sceneId, selfId,  x335270_g_Impact1)
	if(0<nRet) then
		return 1;
	end
	return 0;
...
--**********************************
function  x335270_OnConditionCheck( sceneId, selfId )
	--Ð£ÑéÊ¹ÓÃµÄÎïÆ·
	--if(1~=LuaFnVerifyUsedItem(sceneId, selfId)) then
		--return 0
	--end
	--Á½¸öÆïÊõ£¬»áÒ»¸ö¾Í¿ÉÒÔÁË
	if(-1~= x335270_g_Equitation1) then
		if(1==LuaFnHaveSpecificEquitation(sceneId, selfId,  x335270_g_Equitation1)) then
			return 1
		end
	end
	if(-1~= x335270_g_Equitation2) then
		if(1==LuaFnHaveSpecificEquitation(sceneId, selfId,  x335270_g_Equitation2)) then
			return 1
		end
	end
...
--**********************************
function  x335270_OnDeplete( sceneId, selfId )
	return 1; --Æï³Ë²»ÏûºÄ
end
...
--**********************************
function  x335270_OnActivateOnce( sceneId, selfId )
	if(-1~= x335270_g_Impact1) then
		LuaFnSendSpecificImpactToUnit(sceneId, selfId, selfId, selfId,  x335270_g_Impact1, 0)
	end
...
--×¢£ºÕâÀïÊÇ¼¼ÄÜÉúÐ§Ò»´ÎµÄÈë¿Ú
--**********************************
function  x335270_OnActivateEachTick( sceneId, selfId)
