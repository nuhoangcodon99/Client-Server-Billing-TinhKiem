...
--½Å±¾ºÅ
 x335210_g_scriptId = 335210 --ÁÙÊ±Ð´Õâ¸ö,ÕæÕýÓÃµÄÊ±ºòÒ»¶¨Òª¸Ä.
...
--×¢£ºÁ½¸öÆïÊõ»áÒ»¸ö¾Í¿ÉÒÔÆïÁË
 x335210_g_Equitation1 = 1080 --ÐèÒªµÄÆïÊõ
 x335210_g_Equitation2 = -1 --ÐèÒªµÄÆïÊõ
--Ð§¹ûµÄID
 x335210_g_Impact1 = 5273 --ÁÙÊ±Ð´Õâ¸ö
 x335210_g_Impact2 = -1 --²»ÓÃ

--**********************************
--ÊÂ¼þ½»»¥Èë¿Ú
--**********************************
function  x335210_OnDefaultEvent( sceneId, selfId, bagIndex )
...
--**********************************
function  x335210_IsSkillLikeScript( sceneId, selfId)
...
--**********************************
function  x335210_CancelImpacts( sceneId, selfId )
	nRet = 0;
	nRet = LuaFnCancelSpecificImpact(sceneId, selfId,  x335210_g_Impact1)
	if(0<nRet) then
		return 1;
	end
	return 0;
...
--**********************************
function  x335210_OnConditionCheck( sceneId, selfId )
	--Ð£ÑéÊ¹ÓÃµÄÎïÆ·
	--if(1~=LuaFnVerifyUsedItem(sceneId, selfId)) then
		--return 0
	--end
	--Á½¸öÆïÊõ£¬»áÒ»¸ö¾Í¿ÉÒÔÁË
	if(-1~= x335210_g_Equitation1) then
		if(1==LuaFnHaveSpecificEquitation(sceneId, selfId,  x335210_g_Equitation1)) then
			return 1
		end
	end
	if(-1~= x335210_g_Equitation2) then
		if(1==LuaFnHaveSpecificEquitation(sceneId, selfId,  x335210_g_Equitation2)) then
			return 1
		end
	end
...
--**********************************
function  x335210_OnDeplete( sceneId, selfId )
	return 1; --Æï³Ë²»ÏûºÄ
end
...
--**********************************
function  x335210_OnActivateOnce( sceneId, selfId )
	if(-1~= x335210_g_Impact1) then
		LuaFnSendSpecificImpactToUnit(sceneId, selfId, selfId, selfId,  x335210_g_Impact1, 0)
	end
...
--×¢£ºÕâÀïÊÇ¼¼ÄÜÉúÐ§Ò»´ÎµÄÈë¿Ú
--**********************************
function  x335210_OnActivateEachTick( sceneId, selfId)
