...
--脚本号
 x334805_g_scriptId = 334805 --临时写这个,真正用的时候一定要改.
...
--注：两个骑术会一个就可以骑了
 x334805_g_Equitation1 = 451 --需要的骑术
 x334805_g_Equitation2 = 460 --需要的骑术
--效果的ID
 x334805_g_Impact1 = 4805 --临时写这个
 x334805_g_Impact2 = -1 --不用
