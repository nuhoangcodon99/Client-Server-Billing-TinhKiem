...
--脚本号
 x335102_g_scriptId = 335102 --临时写这个,真正用的时候一定要改.
...
--注：两个骑术会一个就可以骑了
 x335102_g_Equitation1 = 1077 --需要的骑术
 x335102_g_Equitation2 = -1 --需要的骑术
--效果的ID
 x335102_g_Impact1 = 5702 --临时写这个
 x335102_g_Impact2 = -1 --不用
...
function  x335102_CancelImpacts( sceneId, selfId )
	nRet = 0;
	nRet = LuaFnCancelSpecificImpact(sceneId, selfId,  x335102_g_Impact1)
	if(0<nRet) then
		return 1;
	end
	return 0;
...
function  x335102_OnConditionCheck( sceneId, selfId )
	...
	--end
	--两个骑术，会一个就可以了
	if(-1~= x335102_g_Equitation1) then
		if(1==LuaFnHaveSpecificEquitation(sceneId, selfId,  x335102_g_Equitation1)) then
			return 1
		end
	end
	if(-1~= x335102_g_Equitation2) then
		if(1==LuaFnHaveSpecificEquitation(sceneId, selfId,  x335102_g_Equitation2)) then
			return 1
		end
	end
...
function  x335102_OnActivateOnce( sceneId, selfId )
	if(-1~= x335102_g_Impact1) then
		LuaFnSendSpecificImpactToUnit(sceneId, selfId, selfId, selfId,  x335102_g_Impact1, 0)
	end
