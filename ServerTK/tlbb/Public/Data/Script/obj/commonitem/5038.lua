...
--脚本号
 x335033_g_scriptId = 335033 --临时写这个,真正用的时候一定要改.
...
--注：两个骑术会一个就可以骑了
 x335033_g_Equitation1 = 1079 --需要的骑术
 x335033_g_Equitation2 = -1 --需要的骑术
--效果的ID
 x335033_g_Impact1 = 5038 --临时写这个
 x335033_g_Impact2 = -1 --不用
