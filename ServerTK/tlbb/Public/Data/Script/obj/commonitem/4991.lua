...
--脚本号
 x334991_g_scriptId = 334991 --临时写这个,真正用的时候一定要改.
...
--注：两个骑术会一个就可以骑了
 x334991_g_Equitation1 = 426 --需要的骑术
 x334991_g_Equitation2 = -1 --需要的骑术
--效果的ID
 x334991_g_Impact1 = 4991 --临时写这个
 x334991_g_Impact2 = -1 --不用
