...
--脚本号
 x334912_g_scriptId = 334912 --临时写这个,真正用的时候一定要改.
...
--4913  坐骑：陆行雕      446	骑术：陆行雕 
--注：两个骑术会一个就可以骑了
 x334912_g_Equitation1 = 446 --需要的骑术
 x334912_g_Equitation2 = -1 --需要的骑术
--效果的ID
 x334912_g_Impact1 = 4912 --临时写这个
 x334912_g_Impact2 = -1 --不用
