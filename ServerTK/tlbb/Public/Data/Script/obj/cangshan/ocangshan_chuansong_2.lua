...
function x025031_OnDefaultEvent( sceneId, selfId,targetId )
	...
	BeginEvent(sceneId)
		...
		AddText(sceneId,"Có gì ta có th¬ giúp ðßþc ngß½i không?")
			...
			if(strCity0Name ~= "") then AddNumText(sceneId,x025031_g_scriptId,"Thành ph¯ 1 "..strCity0Name,9,0) end
			if(strCity1Name ~= "") then AddNumText(sceneId,x025031_g_scriptId,"Thành ph¯ 2 "..strCity1Name,9,1) end
			if(strCity2Name ~= "") then AddNumText(sceneId,x025031_g_scriptId,"Thành ph¯ 3 "..strCity2Name,9,2) end
			if(strCity3Name ~= "") then AddNumText(sceneId,x025031_g_scriptId,"Thành ph¯ 4 "..strCity3Name,9,3) end
