...
x714129_g_eventList={20104001,20104002,20104003,20104004,20104005,20104006,20104007,20104008,20104009,20104010,
	                   20105001,20105002,20105003,20105004,20105005,20105006,20105007,20105008,20105009,20105010} --Ö²ÎïµÄ±àºÅ,²»ÊÇscriptId

x714129_g_eventList1 = {20104001,20104002,20104003,20104004,20104005,20104006,20104007,20104008,20104009,20104010}; --Á¸Ê³×÷Îï
x714129_g_eventList2 = {20105001,20105002,20105003,20105004,20105005,20105006,20105007,20105008,20105009,20105010}; --¾­¼Ã×÷Îï
...
function x714129_OnEventRequest( sceneId, selfId, targetId, eventId )
	...
	if NumText == 254 or NumText == 255 or NumText == 256 or NumText == 257 then
		BeginEvent(sceneId)
			...
			--Í¨¹ýx714129_g_eventListºÍscriptglobalÖÐµÄÖ²ÎïÁÐ±í¶Ô±È£¬²¢¸ù¾ÝÍæ¼ÒÖÖÖ²¼¼ÄÜµÈÀ´ÏÔÊ¾ÏàÓ¦Ö²Îï
			for i, eventId in x714129_g_eventList_temp do	--±éÀúÕâ¸öµ¾²ÝÈË¿ÉÒÔÖÖÖ²µÄÖ²ÎïÁÐ±í
