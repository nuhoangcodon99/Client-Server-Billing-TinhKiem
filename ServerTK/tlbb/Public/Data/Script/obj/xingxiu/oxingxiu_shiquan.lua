...
function x016007_OnDefaultEvent( sceneId, selfId,targetId )
	...
	if x016007_g_MenPai == 5 then
		BeginEvent(sceneId)
			...
			AddNumText(sceneId, x016007_g_scriptId, "H÷c tâm pháp",12,0)
			
			AddNumText(sceneId, x016007_g_scriptId, "V« h÷c tâm pháp",11,10)
		...
		DispatchEventList(sceneId,selfId,targetId)
			...
			BeginEvent(sceneId)
			AddText(sceneId,"Thi Toàn, sß phø nâng c¤p tâm pháp cüa Tinh Túc !")
		EndEvent(sceneId)
		DispatchEventList(sceneId,selfId,targetId)
	end
end
