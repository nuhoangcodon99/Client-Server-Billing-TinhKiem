...
function x001106_OnDefaultEvent( sceneId, selfId,targetId )
	BeginEvent(sceneId)
		...
		AddNumText(sceneId,x001106_g_ScriptId,"Ta c¥n sØa trang b¸",6,1)
		AddNumText(sceneId,x001106_g_ScriptId,"Tång s¯ l¥n sØa chæa", 6, 2) --zchw
		AddNumText(sceneId, x001106_g_ScriptId,"Gi¾i thi®u sØa chæa trang b¸",11,12);
	EndEvent(sceneId)
