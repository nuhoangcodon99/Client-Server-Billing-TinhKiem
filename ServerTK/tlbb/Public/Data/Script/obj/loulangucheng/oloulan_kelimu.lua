...
--				AddNumText(sceneId, x001119_g_scriptId,"Gi¾i thi®u ðiêu trác Bäo ThÕch",11,12);
				AddNumText(sceneId, x001119_g_scriptId,"Gi¾i thi®u v« Bäo ThÕch dung luy®n",11,13);
				AddNumText(sceneId, x001119_g_scriptId,"Gi¾i thi®u v« th¡ng lþi Bäo ThÕch",11,14);
				AddNumText(sceneId, x001119_g_scriptId,"„ÙÀûŒšÊ¯½é½B",11,15);
