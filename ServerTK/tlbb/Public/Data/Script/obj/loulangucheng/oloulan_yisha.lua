...
function x001133_OnDefaultEvent( sceneId, selfId,targetId )
	...
	BeginEvent(sceneId)
		...
		AddNumText( sceneId, x001133_g_scriptId, "Gi緄 thi畊 s豠 dung m誳", 11, 1 )
		AddNumText(sceneId,x001133_g_scriptId,"S豠 dung m誳",6,2)

		AddNumText( sceneId, x001133_g_scriptId, "Gi緄 thi畊 thay 鸨i h靚h bi瑄 t唼ng nh鈔 v", 11, 3 )
		AddNumText(sceneId,x001133_g_scriptId,"Thay 鸨i h靚h bi瑄 t唼ng nh鈔 v",6,4)
