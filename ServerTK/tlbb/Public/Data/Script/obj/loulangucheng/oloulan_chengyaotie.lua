...
function x001101_OnDefaultEvent( sceneId, selfId, targetId )
	...
	BeginEvent( sceneId )
		...
		AddNumText( sceneId, x001101_g_ScriptId, "Trþ giúp liên quan ðªn khäm nÕm cñc hÕn", 11, 5 )
...
--		DispatchUICommand( sceneId, selfId, 75117 )
	...
	BeginEvent( sceneId )
		AddText( sceneId, "Xin lña ch÷n phß½ng thÑc ðøc l² cñc hÕn:" )
		AddNumText( sceneId, x001101_g_ScriptId, "SØ døng Ði¬m Kim Chi Ti­n ð¬ ðøc l²", 6, 10 )
		AddNumText( sceneId, x001101_g_ScriptId, "SØ døng Hàn Ng÷c Tinh Túy ð¬ ðøc l²", 6, 11 )
	EndEvent(sceneId)
	DispatchEventList(sceneId,selfId,targetId)
