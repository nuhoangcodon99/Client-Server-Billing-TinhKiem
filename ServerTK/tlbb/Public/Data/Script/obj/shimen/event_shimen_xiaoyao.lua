...
x229005_g_AccomplishNPC_Name="T•n Qu·n"

--«∞Ã·»ŒŒÒ
--g_MissionIdPre =

--»ŒŒÒƒø±Ínpc
x229005_g_Name	= "T•n Qu·n"
...
--»ŒŒÒ «∑Ò“—æ≠ÕÍ≥…
x229005_g_IsMissionOkFail = 0		--±‰¡øµƒµ⁄0Œª
...
--»ŒŒÒŒƒ±æ√Ë ˆ
x229005_g_MissionName="NhiÆm v¯ sﬂ mÙn"
x229005_g_MissionInfo=""  --»ŒŒÒ√Ë ˆ
x229005_g_MissionTarget = "%f"
x229005_g_ContinueInfo="L‡m tØt l°m"		--Œ¥ÕÍ≥…»ŒŒÒµƒnpc∂‘ª∞
x229005_g_MissionComplete="ViÆc ta giao „ ho‡n th‡nh chﬂa?"					--ÕÍ≥…»ŒŒÒnpcÀµª∞µƒª∞
...
x229005_g_FormatList = {
								"L‚u l°m khÙng g£p %n r∞i, nhæ qu· i. –‚y %s l‡ ch˙t lÚng th‡nh c¸a ta, xin ngﬂΩi h„y ﬂa tæi gi˙p ta. #R #e00f000Nh°c nhˆ:#e000000#r NgﬂΩi cÛ th¨ ™n Linh Ba –µng tÏm #RL˝ KhØi L≤i#W# #{_INFOAIM69,142,14, L˝ KhØi L≤i}, h„y nh∂ Ùng ta ﬂa ngﬂΩi tæi c·c th‡nh th∏ læn.",
								"%i c¸a ta sao khÙng th§y ‚u? N™u ngﬂΩi cÛ th¨ gi˙p ta tÏm l’i, ta s® khÙng b’c „i ngﬂΩi. #R #e00f000Nh°c nhˆ: #e000000#r NgﬂΩi cÛ th¨ ™n Linh Ba –µng tÏm #RL˝ KhØi L≤i #W#{_INFOAIM69,142,14, L˝ KhØi L≤i}, h„y nh∂ Ùng ta ﬂa ngﬂΩi tæi c·c th‡nh th∏ læn.",
								"%n l‡m i´u ·c, ta ph‰i i d’y b‰o, ·ng ti™c khÙng cÛ th∂i gian, ngﬂΩi cÛ th¨ l‡m thay ﬂ˛c khÙng? #R #e00f000Nh°c nhˆ: #e000000#r NgﬂΩi cÛ th¨ ™n Linh Ba –µng tÏm #RL˝ KhØi L≤i #W#{_INFOAIM69,142,14, L˝ KhØi L≤i}, h„y nh∂ Ùng ta ﬂa ngﬂΩi tæi c·c th‡nh th∏ læn.",
								"Xin ngﬂΩi h„y ∑ ph·i TiÍu Dao %stÏm th§y %s, ∑ g•n Û sÿ d¯ng %s¨ ˜c k˝ —c c¸a nÛ. #R #e00f000Nh°c nhˆ: #e000000#r khi ngﬂΩi l’i g•n th·nh vßt c•n ˜c k˝ —c, §n #gfff0f0Alt+A#g000000cÛ th¨ m∑ m¯c vßt ph¶m, §n v‡o #gfff0f0\"nhiÆm v¯\"#g000000giao diÆn cÛ th¨ m∑ ra m¯c vßt ph¶m nhiÆm v¯, nh§p phÌm ph‰i #gfff0f0m·y th∂i gian#g000000, l‡ cÛ th¨ ho‡n th‡nh.",
								"Xin ngﬂΩi h„y i tÏm th§y %s, huynh §y s® ﬂa ngﬂΩi i thÿ chi™n %s. #R #e00f000Nh°c nhˆ: #e000000#r Ph˘ng A Tam sﬂ huynh ∑ LÂng Ba –µng #{_INFOAIM62,68,14, Ph˘ng A Tam}.",
								...
								"Xin ngﬂΩi h„y ∑ LÂng Ba –µng tÏm ki™m 4 phﬂΩng, tÏm cho ta 5 %s. #R #e00f000Nh°c nhˆ: #e000000#r ngﬂΩi cÛ th¨ tÏm th§y n˙t v‡ng trong b‰n ∞ nh∑ ∑ gÛc ph‰i m‡n hÏnh.",
								"H„y ﬂa %s tæi 1 c·i %i, l‡m xong, ta s® hßu thﬂ∑ng cho ngﬂΩi! #R #e00f000Nh°c nhˆ: #e000000#r Mµc Nh‚n KhØi L≤i ∑ LÂng Ba –µng #{_INFOAIM41,71,14, Mµc Nh‚n KhØi L≤i}. #R Th’ch Nh‚n KhØi L≤i ∑ LÂng Ba –µng #{_INFOAIM59,71,14, Th’ch Nh‚n KhØi L≤i}. #R –∞ng Nh‚n KhØi L≤i ∑ LÂng Ba –µng #{_INFOAIM66,65,14, –∞ng Nh‚n KhØi L≤i}.",
								"–i gi™t ch™t %s %s %n.",
								}
...
x229005_g_DingDianYinDaoList = {
											 {menpai=MP_XIAOYAO  , itemId=40003026, itemName="Th∂i quang cΩ ", scene=14, AreaName="T— ¬n ", subAreaName=" Ph¯ng Ho‡ng C•m ", posx1=39, posz1=140, posx2=60, posz2=160},
											 {menpai=MP_XIAOYAO  , itemId=40003026, itemName="Th∂i quang cΩ ", scene=14, AreaName="Tr‚n Long ", subAreaName=" L’n Kha Kœ ", posx1=135, posz1=142, posx2=162, posz2=157},
											 {menpai=MP_XIAOYAO  , itemId=40003026, itemName="Th∂i quang cΩ ", scene=14, AreaName="–’i quan ", subAreaName=" Th·nh Hi´n Thﬂ ", posx1=37, posz1=46, posx2=59, posz2=66},
											 {menpai=MP_XIAOYAO  , itemId=40003026, itemName="Th∂i quang cΩ ", scene=14, AreaName="–i¨m qu‚n ", subAreaName="Tranh Ωn thanh ", posx1=135, posz1=52, posx2=150, posz2=64},
											}


--∏±±æ¡–±Ì
x229005_g_FuBen_List = {
								{menpai=MP_XIAOYAO  , NpcName="Ph˘ng A Tam", scene=14, posx=62, posz=68, FubenName="CØc –∏a ph¯ b‰n"},
								}       


-- ’ºØ
x229005_g_ShouJiList = {
								{menpai=MP_XIAOYAO  , scene=14, itemId=40003027, itemName="Linh kiÆn mµc ch™"},-- count=5},
								{menpai=MP_XIAOYAO  , scene=14, itemId=40003028, itemName="Linh kiÆn th’ch ch™"},-- count=5},
								{menpai=MP_XIAOYAO  , scene=14, itemId=40003029, itemName="Linh kiÆn ∞ng ch™"},-- count=5},
							}	
...
x229005_g_AbilityNpcList = {
                    {menpai=MP_XIAOYAO  ,npcList={{name="Mµc Nh‚n KhÙi L≤i", scene=14, x=47, z=72},
                                                  {name="–∞ng Nh‚n KhÙi L≤i", scene=14, x=59, z=72},
                                                  {name="Th’ch Nh‚n KhÙi L≤i", scene=14, x=66, z=65}}
										},
									}
...
function x229005_KillMonster_Accept(sceneId, selfId)--…±π÷
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229005_g_StrForePart, 8)--formet◊÷∑˚¥ÆÀ˜“˝
...
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229005_XunWu_Accept(sceneId, selfId)--—∞ŒÔ
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229005_g_StrForePart, 1)--formet◊÷∑˚¥ÆÀ˜“˝
...
function x229005_SongXin_Accept(sceneId, selfId)--ÀÕ–≈
  ...
  local roll = random(3)
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229005_g_StrForePart, 0)--formet◊÷∑˚¥ÆÀ˜“˝
  ...
  SetMissionByIndex(sceneId, selfId, misIndex, x229005_g_StrForePart+3, x229005_g_Xin_ItemId )
	...
	local strMissionTarget = format("L‚u l°m khÙng g£p %s %s, ngﬂΩi h„y gi˙p ta em %s giao cho ngﬂ∂i §y", strNpcScene, strNpcName, x229005_g_ShouJiList[ roll ].itemName )
	AddText(sceneId, strMissionTarget)
	
end

--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229005_DingDianYinDao_Accept(sceneId, selfId)--∂®µ„“˝µº
	--ªÒµ√ÕÊº“µƒ√≈≈…
	local playerMenpai = GetMenPai(sceneId, selfId)
	local a = {}
	local index = 1
	--”√“ª∏ˆ¡Ÿ ±±Ì¿¥¥Ê¥¢∂‘”¶√≈≈…‘⁄x229005_g_DingDianYinDaoList÷–µƒ»´≤øÀ˜“˝
	...
	AddItemListToHuman(sceneId, selfId)	
	Msg2Player(  sceneId, selfId,"#YNgﬂΩi „ ’t ﬂ˛c 1 chi™c#W" .. x229005_g_DingDianYinDaoList[a[ret]].itemName, MSG2PLAYER_PARA )
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229005_g_StrForePart, 3)--formet◊÷∑˚¥ÆÀ˜“˝
	...
	local strMissionTarget = format("Xin ngﬂΩi h„y ∑ ph·i TiÍu Dao %s tÏm th§y %s, ∑ g•n Û sÿ d¯ng %s ¨ ˜c k˝ —c c¸a nÛ", 
...
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229005_FuBenZhanDou_Accept(sceneId, selfId)--’Ω∂∑∏±±æ
	local playerMenpai = GetMenPai(sceneId, selfId)
...
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229005_BuZhuo_Accept(sceneId, selfId)--≤∂◊Ω
	local playerLevel = GetLevel(sceneId, selfId)
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229005_g_StrForePart, 5)--formet◊÷∑˚¥ÆÀ˜“˝
...
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229005_ShouJi_Accept(sceneId, selfId)-- ’ºØ
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229005_g_StrForePart, 6)--formet◊÷∑˚¥ÆÀ˜“˝
	...
	local strMissionTarget = format("Xin ngﬂΩi h„y gi˙p ta ki™m 5 %s v´", x229005_g_ShouJiList[a[ret]].itemName)
	AddText(sceneId, strMissionTarget)
end
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229005_Ability_Accept(sceneId, selfId)--ø™π‚
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229005_g_StrForePart, 7)--formet◊÷∑˚¥ÆÀ˜“˝
...
--»ŒŒÒ»Îø⁄∫Ø ˝
--**********************************
function x229005_OnDefaultEvent( sceneId, selfId, targetId )	--µ„ª˜∏√»ŒŒÒ∫Û÷¥––¥ÀΩ≈±æ
...
function x229005_OnAbandon( sceneId, selfId )
	----PrintStr("OnAbandon...")
	if IsHaveMission(sceneId, selfId, x229005_g_MissionId) > 0 then	
		local misIndex = GetMissionIndexByID(sceneId,selfId,x229005_g_MissionId)		--µ√µΩ»ŒŒÒ‘⁄20∏ˆ»ŒŒÒ÷–µƒ–Ú¡–∫≈
		local missionType = GetMissionParam(sceneId, selfId, misIndex, 1)
...
--…±À¿π÷ŒÔªÚÕÊº“
--**********************************
function x229005_OnKillObject( sceneId, selfId, objdataId ,objId)--≤Œ ˝“‚Àº£∫≥°æ∞∫≈°¢ÕÊº“objId°¢π÷ŒÔ±ÌŒª÷√∫≈°¢π÷ŒÔ
	local misIndex = GetMissionIndexByID(sceneId,selfId,x229005_g_MissionId)
