...
x229002_g_AccomplishNPC_Name="TrﬂΩng Trung H‡nh"

--«∞Ã·»ŒŒÒ
--g_MissionIdPre =

--»ŒŒÒƒø±Ínpc
x229002_g_Name	= "TrﬂΩng Trung H‡nh"
...
--»ŒŒÒ «∑Ò“—æ≠ÕÍ≥…
x229002_g_IsMissionOkFail = 0		--±‰¡øµƒµ⁄0Œª
...
--»ŒŒÒŒƒ±æ√Ë ˆ
x229002_g_MissionName="NhiÆm v¯ sﬂ mÙn"
x229002_g_MissionInfo=""  --»ŒŒÒ√Ë ˆ
x229002_g_MissionTarget = "%f"
x229002_g_ContinueInfo="L‡m tØt l°m"		--Œ¥ÕÍ≥…»ŒŒÒµƒnpc∂‘ª∞
x229002_g_MissionComplete="ViÆc ta giao „ ho‡n th‡nh chﬂa?"					--ÕÍ≥…»ŒŒÒnpcÀµª∞µƒª∞
...
x229002_g_FormatList = {
								"L‚u l°m khÙng g£p %n r∞i, nhæ qu· i. –‚y %s l‡ ch˙t lÚng th‡nh c¸a ta, xin ngﬂΩi h„y ﬂa tæi gi˙p ta. #R #e00f000Nh°c nhˆ: #e000000#r NgﬂΩi cÛ th¨ ™n n˙i Vı –ang tÏm #RM’c Th·i Xung #W#{_INFOAIM101,136,12, M’c Th·i Xung}, h„y nh∂ Ùng ta ﬂa ngﬂΩi tæi c·c th‡nh th∏ læn.",
								"%i c¸a ta sao khÙng th§y ‚u? N™u ngﬂΩi cÛ th¨ gi˙p ta tÏm l’i, ta s® khÙng b’c „i ngﬂΩi. #R #e00f000Nh°c nhˆ: #e000000#r NgﬂΩi cÛ th¨ ™n n˙i Vı –ang tÏm #RM’c Th·i Xung #W#{_INFOAIM101,136,12, M’c Th·i Xung}, h„y nh∂ Ùng ta ﬂa ngﬂΩi tæi c·c th‡nh th∏ læn.",
								"%n l‡m i´u ·c, ta ph‰i i d’y b‰o, ·ng ti™c khÙng cÛ th∂i gian, ngﬂΩi cÛ th¨ l‡m thay ﬂ˛c khÙng? #R #e00f000Nh°c nhˆ: #e000000#r NgﬂΩi cÛ th¨ ™n n˙i Vı –ang tÏm #RM’c Th·i Xung #W#{_INFOAIM101,136,12,M’c Th·i Xung}, h„y nh∂ Ùng ta ﬂa ngﬂΩi tæi c·c th‡nh th∏ læn.",
								"Xin ngﬂΩi h„y d˘ng %s, ∑ Vı –ang %s thu thßp linh khÌ trong %s. #R #e00f000Nh°c nhˆ: #e000000#r khi ngﬂΩi tæi nΩi c•n thu thßp linh khÌ, §n #gfff0f0Alt+A#g000000 cÛ th¨ m∑ m¯c vßt ph¶m, §n v‡o#gfff0f0\"nhiÆm v¯\"#g000000giao diÆn cÛ th¨ m∑ ra m¯c vßt ph¶m nhiÆm v¯, nh§p phÌm ph‰i#gfff0f0 Tÿ Kim H∞ LÙ#g000000, l‡ cÛ th¨ ho‡n th‡nh viÆc thu thßp.",
								"Xin ngﬂΩi h„y i tÏm th§y %s, huynh §y s® ﬂa ngﬂΩi i thÿ chi™n %s. #R #e00f000Nh°c nhˆ: #e000000#r L‚m Linh TØ sﬂ huynh ∑ n˙i Vı –ang #{_INFOAIM58,73,12, L‚m Linh TØ}. ",
								...
								"Xin ngﬂΩi h„y ∑ n˙i Vı –ang tÏm ki™m 4 phﬂΩng, tÏm cho ta 5 %s. #R #e00f000Nh°c nhˆ: #e000000#r NgﬂΩi cÛ th¨ tÏm th§y n˙t v‡ng trong b‰n ∞ nhˆ ∑ gÛc ph‰i m‡n hÏnh.",
								"H„y ﬂa %s tæi 1 c·i %i, l‡m xong, ta s® hßu thﬂ∑ng cho ngﬂΩi! #R #e00f000Nh°c nhˆ: #e000000#r Thanh Minh V‚n H’c ∑ n˙i Vı –ang #{_INFOAIM102,108,12, Thanh Minh V‚n H’c}. #R Cÿu ThiÍn Th•n H’c ∑ n˙i Vı –ang #{_INFOAIM86,84,12, Cÿu ThiÍn Th•n H’c}. #R VÙ K∏ Th•n H’c ∑ n˙i Vı –ang #{_INFOAIM74,85,12, VÙ K∏ Th•n H’c}. ",
								"–i gi™t ch™t %s %s %n.",
								}
...
x229002_g_DingDianYinDaoList = {
											 {menpai=MP_WUDANG   , itemId=40003019, itemName="Tÿ kim h∞ lÙ", scene=12, AreaName="Kim –iÆn", subAreaName="M‚y m˘ ", posx1=72, posz1=39, posx2=100, posz2=65},
											 {menpai=MP_WUDANG   , itemId=40003019, itemName="Tÿ kim h∞ lÙ", scene=12, AreaName="Gi‰i Ki™m TrÏ ", subAreaName="M‚y m˘ ", posx1=36, posz1=170, posx2=52, posz2=190},
											 {menpai=MP_WUDANG   , itemId=40003019, itemName="Tÿ kim h∞ lÙ", scene=12, AreaName="H∞i Long –‡i ", subAreaName="M‚y m˘ ", posx1=70, posz1=127, posx2=86, posz2=149},
											 {menpai=MP_WUDANG   , itemId=40003019, itemName="Tÿ kim h∞ lÙ", scene=12, AreaName="ThiÍn Giæi ", subAreaName="M‚y m˘ ", posx1=42, posz1=64, posx2=50, posz2=89},
											}


--∏±±æ¡–±Ì
x229002_g_FuBen_List = {
								{menpai=MP_WUDANG   , NpcName="L‚m Linh TØ", scene=12, posx=58, posz=73, FubenName="Linh TÌnh Phong ph¯ b‰n"},
								}       

-- ’ºØ
x229002_g_ShouJiList = {
								{menpai=MP_WUDANG   , scene=12, itemId=40003021, itemName="Vı –ang linh chi"},-- count=5},
								{menpai=MP_WUDANG   , scene=12, itemId=40003022, itemName="Vı –ang th¸ Ù"},-- count=5},
								{menpai=MP_WUDANG   , scene=12, itemId=40003023, itemName="Vı –ang nh‚n s‚m "},-- count=5},
							}	
...
x229002_g_AbilityNpcList = {
                    {menpai=MP_WUDANG   ,npcList={{name="Thanh Minh Th•n H’c", scene=12, x=102, z=108},
                                                  {name="Cÿu ThiÍn Th•n H’c", scene=12, x=87, z=85},
                                                  {name="VÙ CÒc Th•n H’c", scene=12, x=75, z=85}}
										},
									}
...
function x229002_KillMonster_Accept(sceneId, selfId)--…±π÷
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229002_g_StrForePart, 8)--formet◊÷∑˚¥ÆÀ˜“˝
...
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229002_XunWu_Accept(sceneId, selfId)--—∞ŒÔ
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229002_g_StrForePart, 1)--formet◊÷∑˚¥ÆÀ˜“˝
...
function x229002_SongXin_Accept(sceneId, selfId)--ÀÕ–≈
  ...
  local roll = random(3)
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229002_g_StrForePart, 0)--formet◊÷∑˚¥ÆÀ˜“˝
  ...
  SetMissionByIndex(sceneId, selfId, misIndex, x229002_g_StrForePart+3, x229002_g_Xin_ItemId )
	...
	local strMissionTarget = format("L‚u l°m khÙng g£p %s %s, ngﬂΩi h„y gi˙p ta em %s giao cho ngﬂ∂i §y", strNpcScene, strNpcName, x229002_g_ShouJiList[ roll ].itemName )
	AddText(sceneId, strMissionTarget)
	
end

--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229002_DingDianYinDao_Accept(sceneId, selfId)--∂®µ„“˝µº
	--ªÒµ√ÕÊº“µƒ√≈≈…
	local playerMenpai = GetMenPai(sceneId, selfId)
	local a = {}
	local index = 1
	--”√“ª∏ˆ¡Ÿ ±±Ì¿¥¥Ê¥¢∂‘”¶√≈≈…‘⁄x229002_g_DingDianYinDaoList÷–µƒ»´≤øÀ˜“˝
	...
	AddItemListToHuman(sceneId, selfId)
	Msg2Player(  sceneId, selfId,"#YNgﬂΩi „ ’t ﬂ˛c 1 chi™c#W" .. x229002_g_DingDianYinDaoList[a[ret]].itemName, MSG2PLAYER_PARA )
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229002_g_StrForePart, 3)--formet◊÷∑˚¥ÆÀ˜“˝
	...
	local strMissionTarget = format("Xin ngﬂΩi h„y d˘ng %s, ∑ Vı –ang %s thu thßp linh khÌ c¸a %s.", 
...
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229002_FuBenZhanDou_Accept(sceneId, selfId)--’Ω∂∑∏±±æ
	local playerMenpai = GetMenPai(sceneId, selfId)
...
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229002_BuZhuo_Accept(sceneId, selfId)--≤∂◊Ω
	local playerLevel = GetLevel(sceneId, selfId)
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229002_g_StrForePart, 5)--formet◊÷∑˚¥ÆÀ˜“˝
...
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229002_ShouJi_Accept(sceneId, selfId)-- ’ºØ
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229002_g_StrForePart, 6)--formet◊÷∑˚¥ÆÀ˜“˝
	...
	local strMissionTarget = format("Xin ngﬂΩi h„y gi˙p ta ki™m 5 %s v´", x229002_g_ShouJiList[a[ret]].itemName)
	AddText(sceneId, strMissionTarget)
end
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229002_Ability_Accept(sceneId, selfId)--ø™π‚
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229002_g_StrForePart, 7)--formet◊÷∑˚¥ÆÀ˜“˝
...
--»ŒŒÒ»Îø⁄∫Ø ˝
--**********************************
function x229002_OnDefaultEvent( sceneId, selfId, targetId )	--µ„ª˜∏√»ŒŒÒ∫Û÷¥––¥ÀΩ≈±æ
...
function x229002_OnAbandon( sceneId, selfId )
	----PrintStr("OnAbandon...")
	if IsHaveMission(sceneId, selfId, x229002_g_MissionId) > 0 then	
		local misIndex = GetMissionIndexByID(sceneId,selfId,x229002_g_MissionId)		--µ√µΩ»ŒŒÒ‘⁄20∏ˆ»ŒŒÒ÷–µƒ–Ú¡–∫≈
		local missionType = GetMissionParam(sceneId, selfId, misIndex, 1)
...
--…±À¿π÷ŒÔªÚÕÊº“
--**********************************
function x229002_OnKillObject( sceneId, selfId, objdataId ,objId)--≤Œ ˝“‚Àº£∫≥°æ∞∫≈°¢ÕÊº“objId°¢π÷ŒÔ±ÌŒª÷√∫≈°¢π÷ŒÔ
	local misIndex = GetMissionIndexByID(sceneId,selfId,x229002_g_MissionId)
