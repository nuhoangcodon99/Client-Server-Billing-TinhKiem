...
x229006_g_AccomplishNPC_Name="Ph˘ MÁn Nghi"

--«∞Ã·»ŒŒÒ
--g_MissionIdPre =

--»ŒŒÒƒø±Ínpc
x229006_g_Name	= "Ph˘ MÁn Nghi"
...
--»ŒŒÒ «∑Ò“—æ≠ÕÍ≥…
x229006_g_IsMissionOkFail = 0		--±‰¡øµƒµ⁄0Œª
...
--»ŒŒÒŒƒ±æ√Ë ˆ
x229006_g_MissionName="NhiÆm v¯ sﬂ mÙn"
x229006_g_MissionInfo=""  --»ŒŒÒ√Ë ˆ
x229006_g_MissionTarget = "%f"
x229006_g_ContinueInfo="L‡m tØt l°m"		--Œ¥ÕÍ≥…»ŒŒÒµƒnpc∂‘ª∞
x229006_g_MissionComplete="ViÆc ta giao „ ho‡n th‡nh chﬂa?"					--ÕÍ≥…»ŒŒÒnpcÀµª∞µƒª∞
...
x229006_g_FormatList = {
								"L‚u l°m khÙng g£p %n r∞i, nhæ qu· i. –‚y %s l‡ ch˙t lÚng th‡nh c¸a ta, xin ngﬂΩi h„y ﬂa tæi gi˙p ta. #R #e00f000Nh°c nhˆ: #e000000#r NgﬂΩi cÛ th¨ ™n Linh Th—u Cung tÏm #R‘ L„o –’i#W# #{_INFOAIM90,120,17, ‘ L„o –’i}, h„y nh∂ Ùng ta ﬂa ngﬂΩi tæi c·c th‡nh th∏ læn.",
								"%i c¸a ta sao khÙng th§y ‚u? N™u ngﬂΩi cÛ th¨ gi˙p ta tÏm l’i, ta s® khÙng b’t „i ngﬂΩi. #R #e00f000Nh°c nhˆ: #e000000#r NgﬂΩi cÛ th¨ ™n Linh Th—u Cung tÏm #R‘ L„o –’i #W#{_INFOAIM90,120,17, ‘ L„o –’i}, h„y nh∂ Ùng ta ﬂa ngﬂΩi tæi c·c th‡nh th∏ læn.",
								"%n l‡m i´u ·c, ta ph‰i i d’y b‰o, ·ng ti™c khÙng cÛ th∂i gian, ngﬂΩi cÛ th¨ l‡m thay ﬂ˛c khÙng? #R #e00f000Nh°c nhˆ: #e000000#r NgﬂΩi cÛ th¨ ™n Linh Th—u Cung tÏm #R‘ L„o –’i #W#{_INFOAIM90,120,17, ‘ L„o –’i}, h„y nh∂ Ùng ta ﬂa ngﬂΩi tæi c·c th‡nh th∏ læn.",
								"Xin ngﬂΩi h„y ∑ ThiÍn SΩn tÏm th§y %s, em %s ± v‡o. #r #e00f000Nh°c nhˆ: #e000000#r Khi ngﬂΩi tæi g•n bÂng hµ c¸a th·nh thu÷ c•n Âng nhßp, §n #gfff0f0Alt+A#g000000 cÛ th¨ m∑ m¯c vßt ph¶m, §n v‡o#gfff0f0\"nhiÆm v¯\"#g000000giao diÆn cÛ th¨ m∑ ra m¯c vßt ph¶m nhiÆm v¯, nh§p phÌm ph‰i#gfff0f0 Th·nh Thu÷#g000000, l‡ cÛ th¨ ho‡n th‡nh.",
								"Xin ngﬂΩi h„y i tÏm th§y %s, t÷ §y s® ﬂa ngﬂΩi i thÿ chi™n %s. #R #e00f000Nh°c nhˆ: #e000000#r C˙c Ki™m t÷ t÷ ∑ Linh Th—u Cung #{_INFOAIM101,44,17, C˙c Ki™m}. ",
								...
								"Xin c·c h’ nhÏn bØn b´ xung quanh ThiÍn SΩn, gi˙p t’i h’ tÏm ra 5 c·i %s. #R #e00f000Nh°c nhˆ: #e000000#r c·c h’ cÛ th¨ tÏm th§y nhÊng i¨m m‡u v‡ng trÍn b‰n ∞ phÌa trÍn gÛc ph‰i m‡n hÏnh.",
								"H„y ﬂa %s tæi 1 c·i %i, l‡m xong, ta s® hßu thﬂ∑ng cho ngﬂΩi! #R #e00f000Nh°c nhˆ: #e000000#r Th’ch T¶u ∑ Linh Th—u Cung #{_INFOAIM123,67,17, Th’ch T¶u}. #R LÙ V˚ –Ïnh t÷ t÷ ∑ Linh Th—u Cung #{_INFOAIM45,69,17, LÙ V˚ –Ïnh}. #R Tang Phi H∞ng t÷ t÷ ∑ Linh Th—u Cung #{_INFOAIM39,71,17, Tang Phi H∞ng}. ",
								"–i gi™t ch™t %s %s %n.",
								}
...
x229006_g_DingDianYinDaoList = {
											 {menpai=MP_TIANSHAN , itemId=40003038, itemName="ThiÍn TrÏ thu÷ ", scene=17, AreaName="Huy´n BÂng Hµ", subAreaName="Huy´n BÂng Hµ", posx1=54, posz1=31, posx2=67, posz2=45},
											 {menpai=MP_TIANSHAN , itemId=40003039, itemName="Th’ch Lµ th¸y ", scene=17, AreaName="H‡n BÂng Hµ", subAreaName="H‡n BÂng Hµ", posx1=70, posz1=57, posx2=77, posz2=69},
											 {menpai=MP_TIANSHAN , itemId=40003040, itemName="L„nh Tuy´n th¸y ", scene=17, AreaName="To·i BÂng Hµ", subAreaName="To·i BÂng Hµ", posx1=117, posz1=85, posx2=130, posz2=96},
											 {menpai=MP_TIANSHAN , itemId=40003041, itemName="Dung BÂng th¸y ", scene=17, AreaName="Nham BÂng Hµ", subAreaName="Nham BÂng Hµ", posx1=123, posz1=46, posx2=135, posz2=57},
											}
...
x229006_g_ShouJiList = {
								...
								{menpai=MP_TIANSHAN , scene=17, itemId=40003043, itemName="Tuy™t liÍn hoa "},-- count=5},
								{menpai=MP_TIANSHAN , scene=17, itemId=40003044, itemName="Dﬂa C·p mßt "},-- count=5},
							}	
...
x229006_g_AbilityNpcList = {
                    {menpai=MP_TIANSHAN ,npcList={{name="Th’ch T¶u", scene=17, x=123, z=67},
                                                  {name="Lﬂ V˚ –Ïnh", scene=17, x=45, z=69},
...
function x229006_KillMonster_Accept(sceneId, selfId)--…±π÷
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229006_g_StrForePart, 8)--formet◊÷∑˚¥ÆÀ˜“˝
...
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229006_XunWu_Accept(sceneId, selfId)--—∞ŒÔ
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229006_g_StrForePart, 1)--formet◊÷∑˚¥ÆÀ˜“˝
...
function x229006_SongXin_Accept(sceneId, selfId)--ÀÕ–≈
  ...
  local roll = random(3)
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229006_g_StrForePart, 0)--formet◊÷∑˚¥ÆÀ˜“˝
  ...
  SetMissionByIndex(sceneId, selfId, misIndex, x229006_g_StrForePart+3, x229006_g_Xin_ItemId )
	...
	local strMissionTarget = format("L‚u l°m khÙng g£p %s %s, ngﬂΩi h„y gi˙p ta em %s giao cho ngﬂ∂i §y", strNpcScene, strNpcName, x229006_g_ShouJiList[ roll ].itemName )
	AddText(sceneId, strMissionTarget)
	
end

--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229006_DingDianYinDao_Accept(sceneId, selfId)--∂®µ„“˝µº
	--ªÒµ√ÕÊº“µƒ√≈≈…
	local playerMenpai = GetMenPai(sceneId, selfId)
	local a = {}
	local index = 1
	--”√“ª∏ˆ¡Ÿ ±±Ì¿¥¥Ê¥¢∂‘”¶√≈≈…‘⁄x229006_g_DingDianYinDaoList÷–µƒ»´≤øÀ˜“˝
	...
	AddItemListToHuman(sceneId, selfId)
	Msg2Player(  sceneId, selfId,"#YNgﬂΩi „ ’t ﬂ˛c 1 chi™c#W" .. x229006_g_DingDianYinDaoList[a[ret]].itemName, MSG2PLAYER_PARA )
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229006_g_StrForePart, 3)--formet◊÷∑˚¥ÆÀ˜“˝
	...
	local strMissionTarget = format("Xin ngﬂΩi h„y ∑ ThiÍn SΩn tÏm th§y %s, em %s ± v‡o", 
...
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229006_FuBenZhanDou_Accept(sceneId, selfId)--’Ω∂∑∏±±æ
	local playerMenpai = GetMenPai(sceneId, selfId)
...
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229006_BuZhuo_Accept(sceneId, selfId)--≤∂◊Ω
	local playerLevel = GetLevel(sceneId, selfId)
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229006_g_StrForePart, 5)--formet◊÷∑˚¥ÆÀ˜“˝
...
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229006_ShouJi_Accept(sceneId, selfId)-- ’ºØ
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229006_g_StrForePart, 6)--formet◊÷∑˚¥ÆÀ˜“˝
	...
	local strMissionTarget = format("Xin ngﬂΩi h„y gi˙p ta ki™m 5 %s v´", x229006_g_ShouJiList[a[ret]].itemName)
	AddText(sceneId, strMissionTarget)
end
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229006_Ability_Accept(sceneId, selfId)--ø™π‚
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229006_g_StrForePart, 7)--formet◊÷∑˚¥ÆÀ˜“˝
...
--»ŒŒÒ»Îø⁄∫Ø ˝
--**********************************
function x229006_OnDefaultEvent( sceneId, selfId, targetId )	--µ„ª˜∏√»ŒŒÒ∫Û÷¥––¥ÀΩ≈±æ
...
function x229006_OnAbandon( sceneId, selfId )
	----PrintStr("OnAbandon...")
	if IsHaveMission(sceneId, selfId, x229006_g_MissionId) > 0 then	
		local misIndex = GetMissionIndexByID(sceneId,selfId,x229006_g_MissionId)		--µ√µΩ»ŒŒÒ‘⁄20∏ˆ»ŒŒÒ÷–µƒ–Ú¡–∫≈
		local missionType = GetMissionParam(sceneId, selfId, misIndex, 1)
...
--…±À¿π÷ŒÔªÚÕÊº“
--**********************************
function x229006_OnKillObject( sceneId, selfId, objdataId ,objId)--≤Œ ˝“‚Àº£∫≥°æ∞∫≈°¢ÕÊº“objId°¢π÷ŒÔ±ÌŒª÷√∫≈°¢π÷ŒÔ
	local misIndex = GetMissionIndexByID(sceneId,selfId,x229006_g_MissionId)
