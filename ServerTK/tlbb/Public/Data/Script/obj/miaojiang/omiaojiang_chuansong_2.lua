...
function x029031_OnDefaultEvent( sceneId, selfId,targetId )
	...
	BeginEvent(sceneId)
		...
		if(strCity0Name ~= "") then AddNumText(sceneId,x029031_g_scriptId,"Thành th¸ 1"..strCity0Name,9,0) end
		if(strCity1Name ~= "") then AddNumText(sceneId,x029031_g_scriptId,"Thành th¸ 2"..strCity1Name,9,1) end
		if(strCity2Name ~= "") then AddNumText(sceneId,x029031_g_scriptId,"Thành th¸ 3"..strCity2Name,9,2) end
		if(strCity3Name ~= "") then AddNumText(sceneId,x029031_g_scriptId,"Thành th¸ 4"..strCity3Name,9,3) end
