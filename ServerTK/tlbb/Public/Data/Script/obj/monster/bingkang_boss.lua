...
function x502003_OnDie( sceneId, objId, killerId )
	...
	if nam_mob ~= nil and nam_ply ~= nil then
		str	= format( "#PTin vui tin vui. #W#{_INFOUSR%s}#P dçn d¡t ðµi ngû anh hùng ðánh bÕi chü nhân cüa Ngân Ngai Tuyªt Nguyên là #G%s#P, m÷i ngß¶i cùng chúc m×ng h¡n nào!", nam_ply, nam_mob )
		AddGlobalCountNews( sceneId, str )
	end
