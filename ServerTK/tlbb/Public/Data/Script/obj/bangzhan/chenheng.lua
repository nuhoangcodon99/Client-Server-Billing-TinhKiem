...
function x402293_UpdateEventList( sceneId, selfId, targetId )
	...
	if CallScriptFunction(402047, "IsCommonAGuild", sceneId, selfId ) == 1 then
		BeginEvent(sceneId);
			...
			AddNumText( sceneId, x402293_g_ScriptId, "Xác ð¸nh", 9, x402293_g_eventId_yes);
			AddNumText( sceneId, x402293_g_ScriptId, "Thü tiêu", 8, x402293_g_eventId_no);
		EndEvent(sceneId);
