...
function x000110_OnDefaultEvent( sceneId, selfId, targetId )
	BeginEvent( sceneId )
		...
		AddNumText( sceneId, x000110_g_scriptId, "Gi¾i thi®u nguyên li®u hþp thành", 11, 20 ) -- add by cuiyinjie 20081021
...
function x000110_OnEventRequest( sceneId, selfId, targetId, eventId )
		...
		if GetNumText() == 0 then
			BeginEvent(sceneId)	
				...
				AddNumText(sceneId, x000110_g_scriptId,"Gi¾i thi®u tách Bäo ThÕch",11,11);
--				AddNumText(sceneId, x000110_g_scriptId,"Gi¾i thi®u hþp thành tinh thiªt",11,12);
				AddNumText(sceneId, x000110_g_scriptId,"Gi¾i thi®u ðiêu trác bäo thÕch",11,13);
				AddNumText(sceneId, x000110_g_scriptId,"Gi¾i thi®u dung luy®n bäo thÕch",11,14);
				AddNumText(sceneId, x000110_g_scriptId,"Gi¾i thi®u th¡ng lþi bäo thÕch",11,15);
		...
		if GetNumText() == 20 then  -- add by cuiyinjie ²ÄÁÏºÏ³É½éÉÜ
			BeginEvent(sceneId)			
				...
				AddNumText(sceneId, x000110_g_scriptId,"Gi¾i thi®u hþp thành tinh thiªt",11,21);
				AddNumText(sceneId, x000110_g_scriptId,"Gi¾i thi®u hþp thành bí ngân",11,22);
				AddNumText(sceneId, x000110_g_scriptId,"Gi¾i thi®u hþp thành väi bông",11,23);					
			EndEvent(sceneId)
			DispatchEventList(sceneId,selfId,targetId)
			return
		end
