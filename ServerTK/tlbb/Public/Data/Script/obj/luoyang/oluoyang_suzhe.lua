			...
			--1.2ÓĞµêÆÌ¸ù¾İ²»Í¬Çé¿ö²»Í¬´¦Àí
				...
				if((strShop0Name ~= "") and (strShop1Name ~= "")) then
						BeginEvent(sceneId)
							...
							AddText(sceneId,"Å¶Å¶£¬Ô­íÊÇÕÆ™™µÄµ½ÁË£¬Õˆ†–ÄúÒªÈ¥ÄÄégµê¿´¿´£¿")

							AddNumText(sceneId,x000000_g_scriptId,"µêä1  "..strShop0Name,-1,4)
							AddNumText(sceneId,x000000_g_scriptId,"µêä2  "..strShop1Name,-1,5)
