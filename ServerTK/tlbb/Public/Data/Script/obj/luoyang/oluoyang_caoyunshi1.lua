...
--¹êÍÃÈüÅÜÈÎÎñÍê³É±ê¼Ç
x311006_g_Mission_IsComplete = 0	--ÈÎÎñ²ÎÊıµÄµÚ0Î»
--¹êÍÃÈüÅÜÂåÑô´ò¿¨±ê¼Ç
x311006_g_LuoYang_RecordIdx = 1		--ÈÎÎñ²ÎÊıµÄµÚ1Î»
--¹êÍÃÈüÅÜËÕÖİ´ò¿¨±ê¼Ç
x311006_g_SuZhou_RecordIdx = 2		--ÈÎÎñ²ÎÊıµÄµÚ2Î»
--¹êÍÃÈüÅÜ´óÀí´ò¿¨±ê¼Ç
x311006_g_DaLi_RecordIdx = 3			--ÈÎÎñ²ÎÊıµÄµÚ3Î»
--¿×Ã÷µÆÍê³ÉÊıÁ¿±ê¼Ç
x311006_g_KongMing_Lighten = 4		--ÈÎÎñ²ÎÊıµÄµÚ4Î»
--¹êÍÃÈüÅÜ´«µİÈÎÎñÃ¿ÌìÂÖÊı±ê¼Ç
x311006_g_RoundIndex = 7					--ÈÎÎñ²ÎÊıµÄµÚ7Î»
...
function x311006_OnDefaultEvent( sceneId, selfId, targetId )
	BeginEvent( sceneId )
		...
		if x311006_OnIsFillPlayCard(sceneId, selfId, targetId) == 1 then
			...
			AddNumText( sceneId, x311006_g_scriptId, "V« Tào V§n", 11, 1 )
			AddNumText( sceneId, x311006_g_scriptId, "Mua thß½ng ph¦m", 7, 2 )
