...
function x000004_UpdateEventList( sceneId, selfId,targetId )
	...
	BeginEvent(sceneId)
	local  PlayerName=GetName(sceneId,selfId)
	AddText(sceneId,"  "..PlayerName..PlayerSex..", g£p ðßþc ngß½i th§t vui quá, g¥n ðây vì s¡p m· ÐÕi hµi Túc c¥u, ngß¶i ra vào thành LÕc Dß½ng s¨ r¤t ðông, hãy chú ý lo an toàn cho Ðoan vß½ng phü");
