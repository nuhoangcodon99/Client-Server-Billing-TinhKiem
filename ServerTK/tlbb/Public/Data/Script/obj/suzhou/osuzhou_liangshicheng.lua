...
{n=9100,id=10422016}, --TLG
{n=9100,id=10423024}, --TLN
}
...
{n=8,id=20309017,num=64,str="VÕn Linh ThÕch c¤p 8"},	--ÓÉ64¸ÄÎª48	--modify by xindefeng

-- ñÒÉÙÎ¢£¬2008.5.29¡£¼«Æ·×°±¸·Å³ö¡£Á½¸ö¶Ò»»ÐèÒªµÄÎïÆ·£º
--ÖØÂ¥Ö®Àá	20310102--ÖØÂ¥Ö®Ã¢
...
function x001067_UpdateEventList( sceneId, selfId,targetId )
	BeginEvent(sceneId)
		...
		AddNumText( sceneId, x001067_g_MenPaiTaoScriptId, "Hoán ð±i trang b¸ môn phái", 6, 846 )
		
		AddNumText( sceneId, x001067_g_ScriptId, "Ð±i l¤y bµ trang b¸ c¤p 18", 0, 1000 )
		AddNumText( sceneId, x001067_g_ScriptId, "Ð±i l¤y bµ trang b¸ c¤p 30", 0, 2000 )
		AddNumText( sceneId, x001067_g_ScriptId, "Ð±i l¤y bµ trang b¸ c¤p 40", 0, 3000 )
		AddNumText( sceneId, x001067_g_ScriptId, "Ð±i l¤y bµ trang b¸ c¤p 50", 0, 4000 )
		AddNumText( sceneId, x001067_g_ScriptId, "Ð±i l¤y bµ trang b¸ c¤p 60", 0, 5000 )
		AddNumText( sceneId, x001067_g_ScriptId, "Ð±i l¤y bµ trang b¸ c¤p 70", 0, 6000 )
		AddNumText( sceneId, x001067_g_ScriptId, "Ð±i l¤y bµ trang b¸ c¤p 80", 0, 7000 )
		AddNumText( sceneId, x001067_g_ScriptId, "Ð±i l¤y bµ trang b¸ c¤p 90", 0, 8000 )

		AddNumText( sceneId, x001067_g_ScriptId, "Ma Binh Thiên Giáng gi¾i thi®u", 11, 10000 )		
		-- ñÒÉÙÎ¢£¬2008.5.29¡£¼«Æ·×°±¸·Å³ö¡£
		AddNumText( sceneId, x001067_g_ScriptId, "Ma Binh Thiên Giáng", 6, 9000 )
  ...
  if nItemBagIndexStone ~= -1 then
	...
	if bDelOk < 1  then
		...
		elseif randMessage == 2 then
			...
			message = format("#W#{WLS_00}#Y%d#Iîw#W#{_INFOMSG%s}#IÓÉÖÔµÄÙµÀ£º¡°#W#{_INFOUSR%s}#{WLS_01}#{_INFOMSG%s}#{WLS_02}", x001067_g_StoneList[nLevel].num, szTransferStone, LuaFnGetName(sceneId, selfId), szTransferEquip);
		end
		
		-- ñÒÉÙÎ¢£¬2008.5.29¡£¼«Æ·×°±¸·Å³ö¡£
		if nLevel == 9 then
			--hd add co dinh item
			local	bindidx	=LuaFnItemBind( sceneId, selfId, nBagIndex)
