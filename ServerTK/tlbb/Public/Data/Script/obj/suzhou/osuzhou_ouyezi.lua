...
function x001066_OnDefaultEvent( sceneId, selfId,targetId )
	BeginEvent( sceneId )
		...
		--end
		AddNumText(sceneId,x001066_g_ScriptId,"Ki¬m ð¸nh tß ch¤t trang b¸",6,4)
		AddNumText(sceneId,x001066_g_ScriptId,"Cß¶ng hóa trang b¸",6,5)
		--AddNumText(sceneId,x001066_g_ScriptId,"Thång c¤p trang b¸",6,6)
		--AddNumText(sceneId,x001066_g_ScriptId,"Thay ð±i ngoÕi hình trang b¸",6,7)

		AddNumText(sceneId,x001066_g_ScriptId,"Tång s¯ l¥n sØa chæa",6,8)
		AddNumText(sceneId,x001066_g_ScriptId,"Trang b¸ kh¡c chÕm",6,9)
		AddNumText(sceneId,x001066_g_ScriptId,"Trang b¸ tr× minh",6,22)
		AddNumText(sceneId,x001066_g_ScriptId,"Giám ð¸nh tß ch¤t trang b¸ lÕi t× ð¥u",6,19)
		--if LuaFnGetName( sceneId, targetId ) == x001066_g_Name then
			AddNumText(sceneId,x001066_g_ScriptId,"Th¥n khí chú tÕo",11,106)
		--end
		
		AddNumText( sceneId, x001066_g_ScriptId, "Trang b¸ kh¡c chÕm", 11, 10 )
