...
function x001069_OnDefaultEvent( sceneId, selfId, targetId )
	...
	BeginEvent( sceneId )
		...
		if GetLevel( sceneId, selfId ) >= 10 then
			AddNumText( sceneId, x001069_g_ScriptId, "Ta mu¯n h÷c tinh luy®n (chª tÕo) ph¯i phß½ng", 2, x001069_g_Key["ln"] )
			...
			AddNumText( sceneId, x001069_g_ScriptId, "Mua ph¯i phß½ng ð°  tß¶ng", 7, x001069_g_Key["sh"])
		end
