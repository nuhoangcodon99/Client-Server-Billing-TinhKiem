...
function x001031_OnDefaultEvent( sceneId, selfId, targetId )
	...
	BeginEvent( sceneId )
		...
		AddNumText( sceneId, x001031_g_ScriptId, "LÓnh tr‚n th˙ chi™n §u danh hiÆu", 6, 10 )
		AddNumText( sceneId, x001031_g_ScriptId, "Giæi thiÆu danh hiÆu tr‚n th˙", 11, 11 )
	EndEvent( sceneId )
...
function x001031_OnAcceptPetTitle( sceneId, selfId, targetId, petHid, petLid )
	...
	if petHid == nil or petLid == nil then
		x001031_MsgBox( sceneId, selfId, targetId, "Tr‚n th˙ c¸a c·c h’ c•n thi™t gia tÂng nÂng lÒc chi™n §u, mæi cÛ th¨ nhßn ﬂ˛c danh hiÆu cao c§p." )
		return
	end
