...
function x002001_UpdateEventList( sceneId, selfId,targetId )
	BeginEvent(sceneId)
		AddText(sceneId,"  Nß¾c ÐÕi Lý có r¤t nhi«u thñc v§t và khoáng sän quý hi¬m, cûng không u±ng công ta t× Bi®n Kinh ngàn d£m xa xôi ðªn ðây, th§t ðúng là chuyªn ði này không phí công chút nào")
