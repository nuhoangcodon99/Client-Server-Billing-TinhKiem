...
x300059_g_strGetItem1 = {
	...
	"#W#{_INFOUSR%s}#P m· bao bánh Trung Thu vÑt ği, không ng¶ có ğ° r½i ra, #W#{_INFOUSR%s}#P løm lên xem thØ, thì ra là #W#{_INFOMSG%s}#P thÑ mà  th¥n tiên cûng không có cho nên không k«m n±i ni«m vui mà cß¶i th§t to",
	"#W#{_INFOUSR%s}#P ği ğß¶ng vô tình v¤p phäi cøc ğá không may b¸ ngã, làm bánh Trung Thu Quª Hoa b¸ ğè nhão, #W#{_INFOUSR%s}#P trong lòng tiªc nu¯i, bèn ån 1 miªng, b²ng nhiên phát hi®n 1 viên #W#{_INFOMSG%s}#P ¦n chÑa trong bánh Trung Thu!",
	"Bánh Trung Thu ngon, tiên ğan khó c¥u, #W#{_INFOUSR%s}#P v×a ån v×a m½ tß·ng Duyên Niên Giäm Th÷, kªt quä trên tr¶i giáng xu¯ng 1 viên #W#{_INFOMSG%s}#P b²ng nhiên r½i vào tay #W#{_INFOUSR%s}#P.",
}

x300059_g_strGetItem2 = {

	"#W#{_INFOUSR%s}#P vui m×ng c¥m l¤y Bánh Trung Thu, hí hØng m· ra, ai ng¶ không c¦n th§n ğánh r½i · dß¾i bàn, #W#{_INFOUSR%s}#P bèn cu¯i xu¯ng tìm, thì b²ng nhiên phát hi®n 1 cái #W#{_INFOMSG%s}#P.",
	"#P Ğêm ğoàn viên, cùng thß·ng Nguy®t, #W#{_INFOUSR%s}#P suy nghî nhi«u thÑ trong ğ¥u, mang theo bánh Trung Thu không nŞ nu¯t, ánh trång phän chiªu, chï th¤y trong bánh Trung Thu có ánh sáng vàng nh¤p nháy, #W#{_INFOUSR%s}#P m· bao bánh Trung Thu nhìn qua thì ra trên m£t có 1 cái #W#{_INFOMSG%s}#P.",
	"#W#{_INFOUSR%s}#P u¯ng rßşu 1 mình dß¾i trång, m¾i v×a ğ¸nh  l¤y bánh Trung Thu Quª Hoa ra ån tñ nhiên phát hi®n trong hµp bánh Trung Thu có 1 cái #W#{_INFOMSG%s}#P, vë vui m×ng li«n lµ hÆn ra m£t mang bö vào trong túi cüa mình.",
}
--**********************************
--ÊÂ¼ş½»»¥Èë¿Ú
--**********************************
