...
--½Å±¾ºÅ
x300034_g_scriptId = 300034

x300034_g_event = 229004

--**********************************
--ÊÂ¼þ½»»¥Èë¿Ú
--**********************************
function x300034_OnDefaultEvent( sceneId, selfId, bagIndex )
--É¨Öã
end
...
--**********************************
function x300034_IsSkillLikeScript( sceneId, selfId)
...
--**********************************
function x300034_CancelImpacts( sceneId, selfId )
	return 0;
end
...
--**********************************
function x300034_OnConditionCheck( sceneId, selfId )
	return CallScriptFunction(x300034_g_event,"CheckCondition_UseItem",sceneId, selfId, -1, -1)
end
...
--**********************************
function x300034_OnDeplete( sceneId, selfId )
	return 1; --²»ÏûºÄ
end
...
--**********************************
function x300034_OnActivateOnce( sceneId, selfId )
	LuaFnSendSpecificImpactToUnit(sceneId, selfId, selfId, selfId, 144, 0);
	CallScriptFunction(x300034_g_event,"Active_UseItem",sceneId, selfId, -1)
...
--×¢£ºÕâÀïÊÇ¼¼ÄÜÉúÐ§Ò»´ÎµÄÈë¿Ú
--**********************************
function x300034_OnActivateEachTick( sceneId, selfId)
