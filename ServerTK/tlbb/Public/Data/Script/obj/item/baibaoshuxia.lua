...
x332205_g_strGongGaoInfo = "#HÔŠÔ»¡°•øÖĞ×ÔÓĞüS½ğÎİ¡±£¬#{_INFOUSR%s}#HÇó•øÈô¿Ê£¬½ñÈÕÅ¼È»égÔÚ#G#{_ITEM30501171}#HÖĞ°l¬FÁËÒ»±¾#{_INFOMSG%s}#H¡£"
...
function x332205_OnConditionCheck( sceneId, selfId )
	...
	if( FreeSpace < 2 ) then
	        local strNotice = "Œ¦²»Æğ£¬ÄúµÄ±³°üÒÑM£¬ÕˆÖÁÉÙÁô³öƒÉ‚€µÀ¾ß™Ú¿Õég¡£"
...
function x332205_ShowRandomSystemNotice( sceneId, selfId, strItemInfo )
	...
	local str = format( "#HÔŠÔ»¡°•øÖĞ×ÔÓĞüS½ğÎİ¡±£¬#{_INFOUSR%s}#HÇó•øÈô¿Ê£¬½ñÈÕÅ¼È»égÔÚ#G#{_ITEM30501171}#HÖĞ°l¬FÁËÒ»±¾#{_INFOMSG%s}#H¡£", PlayerName, strItemInfo )
