...
function x332206_OnConditionCheck( sceneId, selfId )
	...
	if( FreeSpace < 1 ) then
	        local strNotice = "Ô ðÕo cø ðã ð¥y, không th¬ sØ døng."
	...
	if nHaveImpact == 1 then
		local strNotice = "Các hÕ ðã có hi®u Ñng bäo thÕch tinh hoa r°i, hãy chü ðµng huÖ bö hi®u Ñng."
		x332206_ShowNotice( sceneId, selfId, strNotice)
		return 0;
	end
