...
--½Å±¾ºÅ
x300029_g_scriptId = 300029 --ÁÙÊ±Ğ´Õâ¸ö,ÕæÕıÓÃµÄÊ±ºòÒ»¶¨Òª¸Ä.
...
x300029_g_itemList[30503022] = {impactId=4876} --ÀñºĞ±äÉí
x300029_g_itemList[30503023] = {impactId=4877} --Ãµ¹å»¨±äÉí
x300029_g_itemList[30503024] = {impactId=4878} --ÍÃÒ¯±äÉí
...
function x300029_OnConditionCheck( sceneId, selfId )
	...
	if not itemCur then
		x300029_NotifyFailTips(sceneId, selfId, "Chßa m· ğÕo cø, không th¬ sØ døng.");
		return 0;
	end
...
function x300029_OnActivateOnce( sceneId, selfId )
	...
	if itemTblIndex == 30501136 then
		LuaFnDelAvailableItem(sceneId,selfId, 30501136, 1)
	end
	return 1;
end
