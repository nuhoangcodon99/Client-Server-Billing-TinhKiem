...
x332203_g_strGongGaoInfo = {
  "#{_INFOUSR%s}#Hé_†¢#G#{_ITEM30008037}#H•r£¬¾¹È»ÕæµÄÈçîŠ«@µÃÁË#{_INFOMSG%s}#H£¬ÕæÊÇÁîÈËÁwÄ½°¡£¡",
  "#{_INFOUSR%s}#HÕıÔÚÂñÔ¹#G#{_ITEM30008037}#HÌ«Ğ¡•r£¬¾¹È»ÔÚÑeÃæ°l¬FÁËÒ»‚€¸ü´óµÄ#{_INFOMSG%s}£¡",
  "#{_INFOUSR%s}#HéÁË·½±ãÅÜÉÌ£¬ËÄÌŒ¤ÕÒ#{_INFOMSG%s}#H£¬½ñÌì½Kì¶ÔÚ#G#{_ITEM30008037}#HÑeÕÒµ½ÁË£¡",
}
--**********************************
--ÊÂ¼ş½»»¥Èë¿Ú
--**********************************
...
function x332203_OnConditionCheck( sceneId, selfId )
	...
	--hd add
	if (1) then
		x332203_ShowNotice( sceneId, selfId, "V§t ph¦m chßa kích hoÕt");
		return 0;
	end
	--end hd add
