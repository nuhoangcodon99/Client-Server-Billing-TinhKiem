...
function x300043_OnDefaultEvent( sceneId, selfId )
	BeginEvent(sceneId)
		...
		AddText(sceneId, " Tính nång b¸ khóa b·i GM, vui lòng dùng ÐÕi T¦y Tüy Ðan tiªn hành t¦y ði¬m!")
		--AddText(sceneId, " Sau khi sØ døng có th¬ mang b¤t kì 1 thuµc tính nào ðã ph¤n ph¯i l¤y #Y100 ði¬m#W biªn thành ti«m nång.")
		--AddNumText(sceneId, x300043_g_UseScriptId,"Chïnh 100 ði¬m Cß¶ng lñc", 0, 1)
