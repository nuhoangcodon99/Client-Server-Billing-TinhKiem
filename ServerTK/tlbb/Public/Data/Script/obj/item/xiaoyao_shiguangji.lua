...
--½Å±¾ºÅ
x300035_g_scriptId = 300035

x300035_g_event = 229005

--**********************************
--ÊÂ¼þ½»»¥Èë¿Ú
--**********************************
function x300035_OnDefaultEvent( sceneId, selfId, bagIndex )
--É¨Öã
end
...
--**********************************
function x300035_IsSkillLikeScript( sceneId, selfId)
...
--**********************************
function x300035_CancelImpacts( sceneId, selfId )
	return 0;
end
...
--**********************************
function x300035_OnConditionCheck( sceneId, selfId )
	return CallScriptFunction(x300035_g_event,"CheckCondition_UseItem",sceneId, selfId, -1, -1)
end
...
--**********************************
function x300035_OnDeplete( sceneId, selfId )
	return 1; --²»ÏûºÄ
end
...
--**********************************
function x300035_OnActivateOnce( sceneId, selfId )
	LuaFnSendSpecificImpactToUnit(sceneId, selfId, selfId, selfId, 146, 0);
	CallScriptFunction(x300035_g_event,"Active_UseItem",sceneId, selfId, -1)
...
--×¢£ºÕâÀïÊÇ¼¼ÄÜÉúÐ§Ò»´ÎµÄÈë¿Ú
--**********************************
function x300035_OnActivateEachTick( sceneId, selfId)
