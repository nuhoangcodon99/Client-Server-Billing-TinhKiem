...
local  PlayerName=""
--»ŒŒÒ√˚
x804013_g_missionName="–Ím vi™ng M„ phu nh‚n"
x804013_g_missionText_0="–Ím vi™ng M„ phu nh‚n, nhiÆm v¯ hµ tØng"
x804013_g_missionText_1="Hµ tØng –o‡n ChÌnh Thu•n"

x804013_g_missionText_2="NgﬂΩi l‡ ai? Tæi cØc ta l‡m gÏ?"
...
function x804013_OnDefaultEvent( sceneId, selfId, targetId )
  ...
  elseif x804013_CheckAccept(sceneId,selfId) > 0 then
		...
		playname = format("Danh xﬂng c¸a ngﬂ∂i chΩi l‡ : %s\n",name)
		--∑¢ÀÕ»ŒŒÒΩ” ‹ ±œ‘ æµƒ–≈œ¢
		BeginEvent(sceneId)
		AddText(sceneId,x804013_g_missionName)
...
function x804013_OnTimer(sceneId,selfId)
  ...
  if IsInDist(sceneId,selfId,x804013_g_sdhyTargetId,64) < 0 then
  	...
  	Msg2Player(sceneId,selfId,"NhiÆm v¯ b‰o hµ th§t b’i, nhiÆm v¯ b∏ h¸y bˆ",MSG2PLAYER_PARA)
