...
x250001_g_MissionTarget="Bang Vân Hán Nhi tìm ğßşc 1 con Sài Miêu. "		--ÈÎÎñÄ¿±ê
	...
	if indexpet == 255 then --Ë÷ÒıÖµ·µ»Ø255±íÊ¾¿Õ£¬Ã»Ìá½»ÕäÊŞ
		...
		if petdataid == x250001_g_PetDataID then
			--½±Àø½ğÇ®²¢ÌáÊ¾
				...
				BeginEvent(sceneId)
					AddText(sceneId,"Chúc m×ng ğã Hoàn t¤t nhi®m vø, t£ng cho các hÕ #{_MONEY"..x250001_g_MoneyBonus.."}")
				EndEvent(sceneId)
