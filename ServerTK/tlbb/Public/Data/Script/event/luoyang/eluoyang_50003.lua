...
--ÈÎÎñÊÇ·ñÒÑ¾­Íê³É
x250003_g_IsMissionOkFail = 0		--±äÁ¿µÄµÚ0Î»

x250003_g_PetDataID=3020	--ÈÎÎñÕäÊŞµÄ±àºÅ
--ÒÔÉÏÊÇ¶¯Ì¬**************************************************************

--ÈÎÎñ±äÁ¿µÚÒ»Î»ÓÃÀ´´æ´¢Ëæ»úµÃµ½µÄ½Å±¾ºÅ

--ÈÎÎñÎÄ±¾ÃèÊö
x250003_g_MissionName="B¡t trân thú"
x250003_g_MissionInfo="Ti¬u thß nhà tôi mu¯n 1 con Kê. "  --ÈÎÎñÃèÊö
x250003_g_MissionTarget="Bang Vân Hán Nhi tìm ğßşc 1 con Kê. "		--ÈÎÎñÄ¿±ê
x250003_g_ContinueInfo="Các hÕ b¡t ğßşc Kê chßa?"		--Î´Íê³ÉÈÎÎñµÄnpc¶Ô»°
x250003_g_MissionComplete="Làm t¯t l¡m. "					--Íê³ÉÈÎÎñnpcËµ»°µÄ»°
...
--ÈÎÎñÈë¿Úº¯Êı
--**********************************
function x250003_OnDefaultEvent( sceneId, selfId, targetId )	--µã»÷¸ÃÈÎÎñºóÖ´ĞĞ´Ë½Å±¾
	--Èç¹ûÒÑ½Ó´ËÈÎÎñ
...
function x250003_OnAccept( sceneId, selfId )
  ...
  if( 0 == x250003_GetTimePass( sceneId, selfId ) ) then      
	...
	misIndex = GetMissionIndexByID(sceneId,selfId,x250003_g_MissionId)			--µÃµ½ÈÎÎñµÄĞòÁĞºÅ
	SetMissionByIndex(sceneId,selfId,misIndex,0,0)						--¸ù¾İĞòÁĞºÅ°ÑÈÎÎñ±äÁ¿µÄµÚ0Î»ÖÃ0 (ÈÎÎñÍê³ÉÇé¿ö)
	SetMissionByIndex(sceneId,selfId,misIndex,1,x250003_g_ScriptId)						--¸ù¾İĞòÁĞºÅ°ÑÈÎÎñ±äÁ¿µÄµÚ1Î»ÖÃÎªÈÎÎñ½Å±¾ºÅ
...
--É±ËÀ¹ÖÎï»òÍæ¼Ò
--**********************************
function x250003_OnKillObject( sceneId, selfId, objdataId ,objId)--²ÎÊıÒâË¼£º³¡¾°ºÅ¡¢Íæ¼ÒobjId¡¢¹ÖÎï±íÎ»ÖÃºÅ¡¢¹ÖÎïobjId
end
	...
	if indexpet == 255 then --Ë÷ÒıÖµ·µ»Ø255±íÊ¾¿Õ£¬Ã»Ìá½»ÕäÊŞ
		...
		if petdataid == x250003_g_PetDataID then
			--½±Àø½ğÇ®²¢ÌáÊ¾
				...
				BeginEvent(sceneId)
					AddText(sceneId,"Chúc m×ng ğã Hoàn t¤t nhi®m vø, t£ng cho các hÕ #{_MONEY"..x250003_g_MoneyBonus.."}")
				EndEvent(sceneId)
				DispatchEventList(sceneId,selfId,npcid)
			ret0 = DelMission( sceneId, selfId, x250003_g_MissionId ) --É¾³ıÈÎÎñ
