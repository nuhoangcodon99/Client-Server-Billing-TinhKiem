...
x250010_g_MissionTarget="Bang Vân Hán Nhi tìm ðßþc 1 con Thanh Oa. "		--ÈÎÎñÄ¿±ê
x250010_g_ContinueInfo="Các hÕ b¡t ðßþc Thanh Oa chßa?"		--Î´Íê³ÉÈÎÎñµÄnpc¶Ô»°
x250010_g_MissionComplete="Làm t¯t l¡m. "					--Íê³ÉÈÎÎñnpcËµ»°µÄ»°
	...
	if indexpet == 255 then --Ë÷ÒýÖµ·µ»Ø255±íÊ¾¿Õ£¬Ã»Ìá½»ÕäÊÞ
		...
		if petdataid == x250010_g_PetDataID then
			--½±Àø½ðÇ®²¢ÌáÊ¾
				...
				BeginEvent(sceneId)
					AddText(sceneId,"Chúc m×ng ðã Hoàn t¤t nhi®m vø, t£ng cho các hÕ #{_MONEY"..x250010_g_MoneyBonus.."}")
				EndEvent(sceneId)
