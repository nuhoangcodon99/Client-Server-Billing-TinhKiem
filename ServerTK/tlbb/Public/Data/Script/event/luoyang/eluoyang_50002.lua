...
--ÈÎÎñÊÇ·ñÒÑ¾­Íê³É
x250002_g_IsMissionOkFail = 0		--±äÁ¿µÄµÚ0Î»

x250002_g_PetDataID=3010	--ÈÎÎñÕäÊŞµÄ±àºÅ
--ÒÔÉÏÊÇ¶¯Ì¬**************************************************************
...
x250002_g_MissionTarget="Bang Vân Hán Nhi tìm ğßşc 1 con Th¯. "		--ÈÎÎñÄ¿±ê
x250002_g_ContinueInfo="Các hÕ b¡t ğßşc Th¯ chßa?"		--Î´Íê³ÉÈÎÎñµÄnpc¶Ô»°
x250002_g_MissionComplete="Làm t¯t l¡m. "					--Íê³ÉÈÎÎñnpcËµ»°µÄ»°
...
--ÈÎÎñÈë¿Úº¯Êı
--**********************************
function x250002_OnDefaultEvent( sceneId, selfId, targetId )	--µã»÷¸ÃÈÎÎñºóÖ´ĞĞ´Ë½Å±¾
	--Èç¹ûÒÑ½Ó´ËÈÎÎñ
...
function x250002_OnAccept( sceneId, selfId )
  ...
  if( 0 == x250002_GetTimePass( sceneId, selfId ) ) then      
	...
	misIndex = GetMissionIndexByID(sceneId,selfId,x250002_g_MissionId)			--µÃµ½ÈÎÎñµÄĞòÁĞºÅ
	...
	SetMissionByIndex(sceneId,selfId,misIndex,1,x250002_g_ScriptId)						--¸ù¾İĞòÁĞºÅ°ÑÈÎÎñ±äÁ¿µÄµÚ1Î»ÖÃÎªÈÎÎñ½Å±¾ºÅ
...
--É±ËÀ¹ÖÎï»òÍæ¼Ò
--**********************************
function x250002_OnKillObject( sceneId, selfId, objdataId ,objId)--²ÎÊıÒâË¼£º³¡¾°ºÅ¡¢Íæ¼ÒobjId¡¢¹ÖÎï±íÎ»ÖÃºÅ¡¢¹ÖÎïobjId
end
