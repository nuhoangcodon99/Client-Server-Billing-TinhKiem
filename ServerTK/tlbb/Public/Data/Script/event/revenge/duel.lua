...
function x800115_OnDefaultEvent( sceneId, selfId, targetId )
    ...
    if key == 1 then
	   ...
	   if( Level < 20 ) then
            BeginEvent( sceneId )
		        AddText(sceneId,"  –∆ng c§p c¸a c·c h’ khÙng ¸ c§p 20, khÙng th¨ ﬂa ra yÍu c•u quy™t §u")
        ...
        elseif Energy < 100 then
            BeginEvent( sceneId )
		        AddText(sceneId,"  Xin l≤i, chÔ sØ tinh lÒc c¸a c·c h’ khÙng ¸ 100, khÙng th¨ ﬂa ra l∂i yÍu c•u quy™t §u")
				AddNumText( sceneId, x800115_g_ScriptId, "Bi™t r∞i...", -1, 2 )
...
function x800115_OnEnumerate( sceneId, selfId, targetId )
	...
	--if( Level >= 20 ) then
                BeginEvent( sceneId )
		AddText(sceneId,"  Giang h∞ •y ‚n o·n, n™u c·c h’ khÙng trÒc ti™p §u mµt ch˜i mµt, c˚ng cÛ th¨ lÒa ch˜n 1 phﬂΩng ph·p vÂn minh hΩn - quy™t §u. Sau khi Øi phﬂΩng ∞ng ˝, trßn quy™t §u s® b°t •u v‡ s® k™t th˙c sau 1 canh gi∂. Ch™t trong trßn quy™t §u s® b∏ tr◊ng ph’t")
		AddNumText( sceneId, x800115_g_ScriptId, "Ta c•n ﬂa ra yÍu c•u quy™t §u", 6, 1 )
		AddNumText( sceneId, x800115_g_ScriptId, "Ta nghÓ 1 l·t r∞i s® nÛi..", 8, 2 )
	...
	--	AddNumText( sceneId, x800115_g_ScriptId, "÷™µ¿¡À°≠°≠", -1, 2 )
