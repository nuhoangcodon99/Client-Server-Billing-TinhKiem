...
function x800108_ZhuanXingdian(sceneId, selfId, petGUID_H, petGUID_L)
	...
	if not delRet or delRet ~= 1 then
		x800108_ShowTips(sceneId, selfId, "Kh¤u tr×"..zhuanXingdianItemName.."Th¤t bÕi.");
		return 0;
	end
