...
function x402305_OnDefaultEvent( sceneId, selfId, targetId )
	...
	if (nNum == 21) then
		BeginEvent(sceneId)
			...
			AddNumText( sceneId, x402305_g_scriptId, "Tôi mu¯n trao ð±i", 6, 1 )
			AddNumText( sceneId, x402305_g_scriptId, "Tôi mu¯n suy nghî lÕi", 0, 100 )
		EndEvent(sceneId)
	...
	if (nNum == 22) then
		BeginEvent(sceneId)
			...
			AddNumText( sceneId, x402305_g_scriptId, "Tôi mu¯n trao ð±i", 6, 2 )
			AddNumText( sceneId, x402305_g_scriptId, "Tôi mu¯n suy nghî lÕi", 0, 100 )
		EndEvent(sceneId)
		DispatchEventList(sceneId,selfId,targetId,x402305_g_scriptId,0)
	end
	...
	if (nNum == 23) then
		BeginEvent(sceneId)
			...
			AddNumText( sceneId, x402305_g_scriptId, "Tôi mu¯n trao ð±i", 6, 3 )
			AddNumText( sceneId, x402305_g_scriptId, "Tôi mu¯n suy nghî lÕi", 0, 100 )
		EndEvent(sceneId)
		DispatchEventList(sceneId,selfId,targetId,x402305_g_scriptId,0)
	end
	...
	if (nNum == 24) then
		BeginEvent(sceneId)
			...
			AddNumText( sceneId, x402305_g_scriptId, "Tôi mu¯n trao ð±i", 6, 4 )
			AddNumText( sceneId, x402305_g_scriptId, "Tôi mu¯n suy nghî lÕi", 0, 100 )
		EndEvent(sceneId)
		DispatchEventList(sceneId,selfId,targetId,x402305_g_scriptId,0)
	end
