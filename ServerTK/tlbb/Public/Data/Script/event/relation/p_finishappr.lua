...
function x806007_OnAccept( sceneId, selfId, targetId, tId )
	...
	if lv_t >= 40 and lv_t <= 45 and fp_st >= 300 and fp_ts >=300 then
		...
		Msg2Player( sceneId, selfId, "Các hÕ ðã ðÕt ðßþc"..x806007_g_itm[2].."Mµt", MSG2PLAYER_PARA )
		...
		Msg2Player( sceneId, tId, "Các hÕ ðã ðÕt ðßþc"..x806007_g_itm[2].."Mµt", MSG2PLAYER_PARA )
