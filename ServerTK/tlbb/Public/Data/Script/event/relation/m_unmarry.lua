...
function x806005_OnSubmit( sceneId, selfId, targetId, tId )
	...
	BeginEvent( sceneId )
		AddText( sceneId, "  Ch¶ ð¯i phß½ng trä l¶i ...#r  Sau khi lý hôn, ðµ häo hæu s¨ quay v« 10, t¤t cä kÛ nång phu thê s¨ m¤t. #rNam nhân s¨ phäi t¯n #{_EXCHG55555}" )
	EndEvent( sceneId )
	DispatchEventList( sceneId, selfId, targetId )
	BeginEvent( sceneId )
		AddText( sceneId, "  Các hÕ có ð°ng ý ly dÜ v¾i "..selfName.." không ? Sau khi lý hôn, ðµ häo hæu s¨ quay v« 10, t¤t cä kÛ nång phu thê s¨ m¤t. #rNam nhân s¨ phäi t¯n #{_EXCHG55555}" )
