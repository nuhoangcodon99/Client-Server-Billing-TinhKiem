...
function x806003_OnEnumerate(sceneId, selfId, targetId)
	AddNumText(sceneId, x806003_g_ScriptId, "Ta mu¯n kªt bái", 10, x806003_g_eventId_marry);
end
...
function x806003_OpenMarryLevelUI(sceneId, selfId, targetId)
	BeginEvent(sceneId);
		...
		AddText(sceneId, "#{yuelao_jiehun}#r hôn l­ thông thß¶ng, c¥n bö ti«n#{_EXCHG"..moneyLevel0.."}; hôn l­ quy mô b§c trung, c¥n tiêu t¯n #{_EXCHG"..moneyLevel1.."}. hôn l­ quy mô hào hoa, c¥n tiêu t¯n #{_EXCHG"..moneyLevel2.."}.");
...
function x806003_SelfCheckSelectMarryLevel(sceneId, selfId, targetId, marryLevel)
	...
	BeginEvent(sceneId);
		if marryLevel == 2 then
			AddText(sceneId, "Các hÕ ðã ch÷n r°i "..x806003_GetMarryLevelName(marryLevel)..", ð°ng th¶i các hÕ s¨ phäi trä #Y"..GetItemName(sceneId, x806003_g_ticketItemId).."#Who£c#{_EXCHG"..x806003_CalcNeedMoney(marryLevel).."}#rCác ngß½i ðã quyªt ð¸nh l§p gia th¤t chßa, và cuµc s¯ng tiªp t¾i s¨ b¤t di b¤t d¸ch?");
		else
			AddText(sceneId, "Các hÕ ðã ch÷n r°i "..x806003_GetMarryLevelName(marryLevel)..", ð°ng th¶i các hÕ s¨ phäi trä #Y"..GetItemName(sceneId, x806003_g_ticketItemId).."#Who£c#Y"..GetItemName(sceneId, x806003_g_ticketItemId2).."#Who£c#{_EXCHG"..x806003_CalcNeedMoney(marryLevel).."}#rCác ngß½i ðã quyªt ð¸nh l§p gia th¤t chßa, và cuµc s¯ng tiªp t¾i s¨ b¤t di b¤t d¸ch?");
		end
		...
		AddNumText(sceneId, x806003_g_ScriptId, "HuÖ", 8, x806003_g_eventId_selfCancelLevel);
	EndEvent(sceneId);
	DispatchEventList(sceneId, selfId, targetId);
...
function x806003_TargetCheckSelectMarryLevel(sceneId, selfId, targetId, marryLevel)
	...
	if marryTargetId ~= -1 then
		...
		BeginEvent(sceneId);
			if marryLevel == 2 then
				AddText(sceneId, "Ð¯i phß½ng ðã ch÷n xong"..x806003_GetMarryLevelName(marryLevel)..", ð°ng th¶i ð¯i phß½ng s¨ phäi trä#Y"..GetItemName(sceneId, x806003_g_ticketItemId).."#Who£c#{_EXCHG"..x806003_CalcNeedMoney(marryLevel).."}, #r#rCác ngß½i ðã quyªt ð¸nh l§p gia th¤t chßa, và cuµc s¯ng tiªp t¾i s¨ b¤t di b¤t d¸ch?");
			else
				AddText(sceneId, "Ð¯i phß½ng ðã ch÷n xong"..x806003_GetMarryLevelName(marryLevel)..", ð°ng th¶i ð¯i phß½ng s¨ phäi trä#Y"..GetItemName(sceneId, x806003_g_ticketItemId).."#W ho£c#Y"..GetItemName(sceneId, x806003_g_ticketItemId2).."#Who£c#{_EXCHG"..x806003_CalcNeedMoney(marryLevel).."}, #r#rCác ngß½i ðã quyªt ð¸nh l§p gia th¤t chßa, và cuµc s¯ng tiªp t¾i s¨ b¤t di b¤t d¸ch?");
			end
			...
			AddNumText(sceneId, x806003_g_ScriptId, "Duy®t", 6, tempAcceptEventID);
			AddNumText(sceneId, x806003_g_ScriptId, "HuÖ", 8, x806003_g_eventId_targetCancelLevel);
		EndEvent(sceneId);
