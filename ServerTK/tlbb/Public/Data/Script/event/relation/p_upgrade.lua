...
function x806015_OnDefaultEvent( sceneId, selfId, targetId )
	...
	if key == x806015_g_Update["wu"] then
		...
		local msg = "ÐÆng c¤p sß ðÑc cüa các hÕ ðßþc thång c¤p t¾i" .. tostring( LuaFnGetmasterLevel( sceneId, selfId ) .. "c¤p." )
...
--	x806015_MessageBox( sceneId, selfId, targetId, msg )
	...
	local	str	= format( "#cffffccXin chúc m×ng#W#{_INFOUSR%s}#cffffcc thành công ðÕt ðßþc #G%s#cffffcc danh xßng, có th¬ thu nh§n nhæng ngß¶i ch½i khác làm ð° ð®.", nam, x806015_g_Title[level] )
