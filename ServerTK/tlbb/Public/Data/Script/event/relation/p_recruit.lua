...
x806008_g_msg["ts"]	= " Có v¤n ð« v« quan h® sß ð°, không th¬ kªt bái"
...
function x806008_OnSubmit( sceneId, selfId, targetId, tId )
	...
	str		= format( "Chúc m×ng ngß½i ðã bái%slàm sß phø. Sau khi nh§n xong, giªt quái, kinh nghi®m s¨ tång lên 10%. Nªu cùng sß phø nh§p nhóm giªt quái s¨ tång lên 20%. Sau khi lên c¤p 40, nhæng t£ng thß·ng kinh nghi®m s¨ b¸ xóa bö", MasterName )
