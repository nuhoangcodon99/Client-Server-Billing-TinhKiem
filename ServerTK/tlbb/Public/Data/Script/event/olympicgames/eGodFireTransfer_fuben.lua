...
x808094_g_FubenDataTbl[1] =
{
	...
	MonsterName = "Lam C•u", BossName = "Ti¨u Kœ Kœ", BossTitle = "KhÙng Trung Phi Nh‚n", FubenName = "Ti™n nhßp Lam C•u Trﬂ∂ng",
...
x808094_g_FubenDataTbl[2] =
{
	...
	NPCName = "–ao NghÍu ", MissionId = 1006,
	MonsterName = "B‡i C•u", BossName = "Ti¨u Nhu‹ Nhu‹", BossTitle = "Pha Ly M€ Nh‚n", FubenName = "Ti™n nhßp B‡i C•u Trﬂ∂ng",
...
x808094_g_FubenDataTbl[3] =
{
	...
	NPCName = "Chu VÙ U˝ ", MissionId = 1010,
	MonsterName = "T˙c C•u", BossName = "Ti¨u T´ T´", BossTitle = "B‡n C•u –’i Sﬂ", FubenName = "Ti™n nhßp T˙c C•u Trﬂ∂ng",
...
function x808094_MakeCopyScene( sceneId, selfId, fubenType )
	...
	BeginEvent(sceneId)
		if bRetSceneID>0 then
			...
			AddText(sceneId,"SØ lﬂ˛ng b‰n sao qu· h’n, vui lÚng l·t nÊa thÿ l’i !");
		end
	EndEvent(sceneId)
...
function x808094_OnCopySceneTimer( sceneId, nowTime )
	...
	--»Áπ˚…±À¿¡ÀBOSS‘Úµπº∆ ±πÿ±’....
	if nStep == 2 then
		x808094_TipAllHuman( sceneId, "Ph¯ b‰n s® Ûng sau 30 gi‚y nÊa" )
	...
	if nStep == 4 then
		x808094_TipAllHuman( sceneId, "Ph¯ b‰n s® Ûng sau 20 gi‚y nÊa" )
	...
	if nStep == 6 then
		x808094_TipAllHuman( sceneId, "Ph¯ b‰n s® Ûng sau 10 gi‚y nÊa" )
		LuaFnSetCopySceneData_Param(sceneId, 12, 7 )
	end

	if nStep == 7 then
		x808094_TipAllHuman( sceneId, "Ph¯ b‰n s® Ûng sau 5 gi‚y nÊa" )
