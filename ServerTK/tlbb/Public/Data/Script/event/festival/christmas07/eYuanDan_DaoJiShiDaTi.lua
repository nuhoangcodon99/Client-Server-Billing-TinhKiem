...
-- 奖励的物品          
x050028_g_BonusItem = 30505147
x050028_g_Name      = "Ti玭 Long "
x050028_g_LowLevel  = 10
                       
x050028_g_StartDayTime = 20120101		-- 活动开始时间
x050028_g_EndDayTime	 = 20120103		-- 活动结束时间
...
function x050028_OnPlayerQuizFinish( sceneId, selfId )
	...
	local playerexp = GetMissionData( sceneId, selfId, MD_DAOJISHIDATI_EXP )+floor(x050028_g_BonusExp[playerlvl]*5.5)
	
	LuaFnAddExp( sceneId, selfId, playerexp )
