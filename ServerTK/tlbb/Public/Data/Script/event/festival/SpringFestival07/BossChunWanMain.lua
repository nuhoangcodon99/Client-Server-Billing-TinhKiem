...
x050030_g_StartDayTime	= 12022		--»î¶¯¿ªÊ¼(Ê×²¥)Ê±¼ä 2009-4-8
x050030_g_EndDayTime		= 12029		--»î¶¯½áÊøÊ±¼ä 2009-5-12
...
x050030_g_BOSSTbl = {
	...
	--ËïÃÀÃÀ....
	["SunMeiMei"] 		= { dateId = 3891, createMsg = "Vô" },
	...
	["YingYing"] 			= { dateId = 3928, createMsg = "Vô" },
	["ZhuZhu"]				= { dateId = 3926, createMsg = "Vô" },
	["FeiTianMao"]		= { dateId = 3916, createMsg = "#{SpringFestiva2007_BOSS_13}" },
	["GouGou"]				= { dateId = 3927, createMsg = "Vô" },
	["HuHu"]					= { dateId = 3929, createMsg = "Vô" },
...
function x050030_CreateBossActor( sceneId, strName, posX, posY, notify )
	...
	if notify and notify == 1 and notify2 == 1 then
		local msg = "#P[Chü trì l­ hµi xuân-Tôn MÛ MÛ] :#W"..bossData.createMsg
