...
--»î¶¯Ê±¼ä
x050054_g_StartDayTime = 12000   --»î¶¯½áÊøÊ±¼ä 2008-1-31
x050054_g_EndDayTime = 12044   --»î¶¯½áÊøÊ±¼ä 2008-2-14
...
x050054_g_strNotSpace = "Các hÕ không có ðü ch² tr¯ng · tai nãi, hãy s¡p xªp lÕi ô ðÕo cø"
...
function x050054_OnEnumerate( sceneId, selfId, targetId )
    ...
    local isTime = x050054_CheckRightTime()
    if 1 == isTime then
			AddNumText(sceneId, x050054_g_ScriptId, "C¤p cho tôi mµt quä pháo", 6, 101 )													
    end
