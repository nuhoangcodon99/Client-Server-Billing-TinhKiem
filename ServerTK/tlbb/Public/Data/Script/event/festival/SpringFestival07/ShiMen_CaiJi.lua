...
-- ÈÎÎñÎÄ±¾ÃèÊö
x050059_g_MissionName = "Môn phái niên hoá ðÕi bi®n c¤u"
...
--¶Ò»»Ê±¼ä
x050059_ChangeTime_Start =  12000 --¶Ò»»¿ªÊ¼2009Äê1ÔÂ25ÈÕ0Ê±
x050059_ChangeTime_End   =  12044  --¶Ò»»½ØÖÁ2009Äê2ÔÂ7ÈÕ24Ê±
...
function x050059_GetStrIndexByStrValue(stringV)
	...
	local strText = format("%s phäi ðßþc ðång kí trong StrList ", stringV)
	----PrintStr(strText)
	return 0;
end
...
function x050059_Accept(sceneId, selfId,MissionID,ScriptID)
	...
	Msg2Player(sceneId, selfId, "#YTiªp nh§n nhi®m vø : Môn phái Ngày Tªt", MSG2PLAYER_PARA )
	...
	AddText(sceneId,"Hôm nay ðây là ngày ð¥u tiên "..(floor(iDayCount/x050059_g_Times)+1).." vòng "..iTimes.." vòng")
