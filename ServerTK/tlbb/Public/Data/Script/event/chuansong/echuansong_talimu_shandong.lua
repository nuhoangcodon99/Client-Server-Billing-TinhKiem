...
function x400938_OnEnterArea( sceneId, selfId,a,b )
	...
	BeginUICommand(sceneId)
		...
		UICommand_AddString(sceneId, "Tháp Kh¡c LÕp Mã là n½i nguy hi¬m trùng trùng, xin hãy chú ı ğªn an toàn, các hÕ mu¯n vào ?");
...
--ÈÎÎñÈë¿Úº¯Êı
--**********************************
function x400938_GotoTKLMG( sceneId, selfId, targetId )	--µã»÷¸ÃÈÎÎñºóÖ´ĞĞ´Ë½Å±¾
