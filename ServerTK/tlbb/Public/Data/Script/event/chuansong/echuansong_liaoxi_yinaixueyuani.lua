...
function x400925_OnEnterArea( sceneId, selfId )
		...
		UICommand_AddString(sceneId, "Ngân Ngai Tuyªt Nguyên là n½i nguy hi¬m trùng trùng, xin hãy chú ı ğªn an toàn, các hÕ mu¯n vào ?");
...
--ÈÎÎñÈë¿Úº¯Êı
--**********************************
function x400925_GotoYinaixueyuan( sceneId, selfId, targetId )	--µã»÷¸ÃÈÎÎñºóÖ´ĞĞ´Ë½Å±¾
