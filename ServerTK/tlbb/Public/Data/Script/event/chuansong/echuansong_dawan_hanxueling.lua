...
function x400944_OnEnterArea( sceneId, selfId )
	...
	BeginUICommand(sceneId)
		...
		UICommand_AddString(sceneId, "HÕn Huyªt Lînh là n½i nguy hi¬m trùng trùng, xin hãy chú ı ğªn an toàn, các hÕ mu¯n vào ?");
...
--ÈÎÎñÈë¿Úº¯Êı
--**********************************
function x400944_GotoHanXueLing( sceneId, selfId, targetId )	--µã»÷¸ÃÈÎÎñºóÖ´ĞĞ´Ë½Å±¾
