...
x500027_g_Signpost = {
	{ type=2, name="Vân Th¸ Ti«n Trang lão bän", x=93, y=177, tip="Vß½ng phu nhân ", desc="Bà chü ti«n trang Vß½ng Phu nhân (93, 177) · ti«n trang hß¾ng nam ðß¶ng l¾n phía Tây, nô bµc cüa bà có th¬ giúp ngß½i c¤t giæ v§t ph¦m và ngân lßþng. „n phím TAB, trên bän ð° có ký hi®u nh¤p nháy", eventId=-1 },
}
