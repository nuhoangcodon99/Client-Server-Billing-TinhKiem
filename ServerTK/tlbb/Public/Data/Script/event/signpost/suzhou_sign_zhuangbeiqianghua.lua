...
x500028_g_Signpost = {
	{ type=2, name="ÐÕi tông sß", x=266, y=139, tip="Âu Dã TØ", desc="Âu Dã TØ (266, 139) có th¬ giúp ngß½i cß¶ng hóa trang b¸ và giám ð¸nh tß ch¤t trang b¸. „n phím TAB, trên bän ð° có ký hi®u nh¤p nháy", eventId=-1 },
}
