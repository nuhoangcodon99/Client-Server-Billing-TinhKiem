...
function x200040_OnCopySceneTimer( sceneId, nowTime )
	...
	if nStep1==1 then
		...
		elseif nStep2==4 	then
			CallScriptFunction((200060), "Paopao",sceneId, "Ğoàn Diên Khánh", "Lôi C± S½n", "#{JQ_PaoPao_93}")
		...
		elseif nStep2==8 	then
			CallScriptFunction((200060), "Paopao",sceneId, "Ğoàn Diên Khánh", "Lôi C± S½n", "#{JQ_PaoPao_95}")
		...
		elseif nStep2==10 then
			CallScriptFunction((200060), "Paopao",sceneId, "Ğinh Xuân Thu", "Lôi C± S½n", "#{JQ_PaoPao_96}")
		...
		elseif nStep2==12 then
			CallScriptFunction((200060), "Paopao",sceneId, "Ğoàn Diên Khánh", "Lôi C± S½n", "#{JQ_PaoPao_97}")
		...
		elseif nStep2==14 then
			CallScriptFunction((200060), "Paopao",sceneId, "Ğoàn Diên Khánh", "Lôi C± S½n", "#{JQ_PaoPao_98}")
