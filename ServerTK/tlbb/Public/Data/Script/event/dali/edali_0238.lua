...
x210238_g_MissionInfo1 = "    Nhßng gi¶ ğây vi®c quan tr÷ng nh¤t cüa các hÕ, là phäi n¡m væng cån c¾ võ h÷c. Sau khi n¡m væng cån c¾, có th¬ tìm mµt v¸ danh sß, h÷c võ công uyên thâm h½n. Sau này tr· thành mµt ğÕi anh hùng, ğÕi hi®p sî!"
...
function x210238_OnAccept( sceneId, selfId )
	...
	Msg2Player(  sceneId, selfId,"Nh§n nhi®m vø: #Y" .. x210238_g_MissionName, MSG2PLAYER_PARA )
	local misIndex = GetMissionIndexByID(sceneId, selfId, x210238_g_MissionId)--µÃµ½ÈÎÎñÔÚ20¸öÈÎÎñÖĞµÄĞòÁĞºÅ
