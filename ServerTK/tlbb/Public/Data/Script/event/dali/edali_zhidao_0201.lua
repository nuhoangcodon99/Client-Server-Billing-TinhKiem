...
x210201_g_MissionTarget="Mang #Ymµt hÚm d¯ng c¯ B™p#W ™n#G ﬂ∂ng læn phÌa T‚y th‡nh –’i L˝#Y Tÿu qu·n#W cho Ùng ch¸ #R–≤ Tÿ –¢ng #W#{_INFOAIM110,159,2, –≤ Tÿ –¢ng}. "
...
function x210201_OnAccept( sceneId, selfId )
	...
	if ret > 0 then
		...
		Msg2Player(  sceneId, selfId,"#YNhßn nhiÆm v¯: giao h‡ng l•n 1",MSG2PLAYER_PARA )
...
function x210201_OnSubmit( sceneId, selfId, targetId, selectRadioId )
	if x210201_CheckSubmit( sceneId, selfId, selectRadioId ) == 1 then
		...
		--…Ë÷√»ŒŒÒ“—æ≠±ªÕÍ≥…π˝
		Msg2Player(  sceneId, selfId,"#YHo‡n t§t nhiÆm v¯#W: giao h‡ng l•n 1",MSG2PLAYER_PARA )
