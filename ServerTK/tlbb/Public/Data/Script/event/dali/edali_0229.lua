...
--ÈÎÎñÃû
x210229_g_MissionName="Ği tìm lÕi #RTri®u Thiên Sß#W"
x210229_g_MissionInfo="#{event_dali_0042}"
x210229_g_MissionTarget="    V« #GNgû Hoa Ğàn thành ĞÕi Lı#W tìm #RTri®u Thiên Sß #W#{_INFOAIM160,157,2,Tri®u Thiên Sß}. "
...
function x210229_OnAccept( sceneId, selfId )
	...
	Msg2Player(  sceneId, selfId,"#YNh§n nhi®m vø#W: LÕi ği tìm Tri®u Thiên Sß",MSG2PLAYER_PARA )
		...
		--Ìí¼ÓÈÎÎñ½±Àø
			if ret > 0 then
				...
				if ret > 0 then
					...
					Msg2Player(  sceneId, selfId,"#YHoàn t¤t nhi®m vø#W: LÕi ği tìm Tri®u Thiên Sß",MSG2PLAYER_PARA )
				end
			else
				--ÈÎÎñ½±ÀøÃ»ÓĞ¼Ó³É¹¦
				BeginEvent(sceneId)
