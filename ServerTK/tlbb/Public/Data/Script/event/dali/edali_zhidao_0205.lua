...
x210205_g_MissionTarget="ó #GNg˚ Hoa –‡n th‡nh –’i L˝#W tÏm 1 trong t— ’i thiÆn nh‚n #RTi´n Long #W#{_INFOAIM145,139,2, Ti´n Long}. "
...
function x210205_OnAccept( sceneId, selfId )
	...
	Msg2Player(  sceneId, selfId,"#Yti™p nhßnnhiÆm v¯#W: quen b’n mæi",MSG2PLAYER_PARA )
...
function x210205_OnSubmit( sceneId, selfId, targetId, selectRadioId )
	if x210205_CheckSubmit( sceneId, selfId, selectRadioId ) == 1 then
		...
		Msg2Player(  sceneId, selfId,"#YHo‡n t§t nhiÆm v¯#W: quen b’n mæi",MSG2PLAYER_PARA )
