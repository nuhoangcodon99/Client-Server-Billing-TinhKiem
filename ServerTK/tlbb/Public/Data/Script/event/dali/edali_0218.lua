...
--»ŒŒÒŒƒ±æ√Ë ˆ
x210218_g_MissionName="Ta muØn 1 con thˆ"
x210218_g_MissionInfo="–ﬂ˛c r∞i, nhÏn ngﬂΩi l‡ ngﬂ∂i mæi ™n, cho ngﬂΩi 1 con ti¨u thØ, ngﬂΩi ph‰i yÍu thﬂΩng nÛ. "  --»ŒŒÒ√Ë ˆ
x210218_g_MissionTarget="    G˜i ta 1 ti™ng ch∏ PhiÍu PhiÍu. "		--»ŒŒÒƒø±Í
x210218_g_ContinueInfo="–‚y l‡ con thˆ ta nuÙi d’y ·ng yÍu nh§t, ngﬂΩi ph‰i chÂm sÛc nÛ c¶n thßn. "		--Œ¥ÕÍ≥…»ŒŒÒµƒnpc∂‘ª∞
x210218_g_MissionComplete="ChΩi vui vÎ ∑ –’i L˝. "					--ÕÍ≥…»ŒŒÒnpcÀµª∞µƒª∞
...
function x210218_OnDefaultEvent( sceneId, selfId, targetId )	--µ„ª˜∏√»ŒŒÒ∫Û÷¥––¥ÀΩ≈±æ
	...
	ret, retGUID_H, retGUID_L = LuaFnCreatePetToHuman(sceneId, selfId, x210218_g_PetDataID, -1, 0) --∏¯ÕÊº“…˙≥…“ª÷ª’‰ ﬁ
	if ret == 1 then 
		--œ¬∏ˆ¥∞ø⁄£¨Ã· æÕÊº““ª–©ª∞
		BeginEvent(sceneId)
