...
x210232_g_MissionTarget="    V« #GNgû Hoa Ğàn thành ĞÕi Lı#W tìm #RTri®u Thiên Sß #W#{_INFOAIM160,157,2,Tri®u Thiên Sß}. "
...
function x210232_OnAccept( sceneId, selfId )
	...
	Msg2Player(  sceneId, selfId,"#YNh§n nhi®m vø#W: ta có th¬ nh§p môn phái",MSG2PLAYER_PARA )
		...
		--Ìí¼ÓÈÎÎñ½±Àø
			if ret > 0 then
				...
				if ret > 0 then
					...
					Msg2Player(  sceneId, selfId,"#YHoàn t¤t nhi®m vø#W: ta có th¬ nh§p môn phái",MSG2PLAYER_PARA )
				end
			else
				--ÈÎÎñ½±ÀøÃ»ÓĞ¼Ó³É¹¦
				BeginEvent(sceneId)
