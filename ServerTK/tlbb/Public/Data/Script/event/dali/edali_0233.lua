...
--ÈÎÎñÈë¿Úº¯Êı
--**********************************
function x210233_OnDefaultEvent( sceneId, selfId, targetId )	--µã»÷¸ÃÈÎÎñºóÖ´ĞĞ´Ë½Å±¾
	--·¢ËÍÈÎÎñĞèÇóµÄĞÅÏ¢
	BeginEvent(sceneId)
		...
		if ret > 0 then
			...
			if	ret > 0 then
				...
				if ret > 0 then
					...
					Msg2Player(  sceneId, selfId,"#YHoàn t¤t nhi®m vø#W: Ban t£ng Tinh Phß·ng MÕo",MSG2PLAYER_PARA )
				end
			else
				--É¾³ıÎïÆ·²»³É¹¦
				BeginEvent(sceneId)
...
--É±ËÀ¹ÖÎï»òÍæ¼Ò
--**********************************
function x210233_OnKillObject( sceneId, selfId, objdataId ,objId)--²ÎÊıÒâË¼£º³¡¾°ºÅ¡¢Íæ¼ÒobjId¡¢¹ÖÎï±íÎ»ÖÃºÅ¡¢¹ÖÎïobjId
end
