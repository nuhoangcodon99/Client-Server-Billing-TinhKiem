...
x210214_g_MissionTarget="–™n #YTr˘ng –i¨u phﬂ∂ng#W ∑ #Gﬂ∂ng læn phÌa –Ùng c¸a th‡nh –’i L˝#W tÏm phﬂ∂ng ch¸ #RV‚n PhiÍu PhiÍu #W#{_INFOAIM265,129,2, V‚n PhiÍu PhiÍu}. "
...
x210214_g_SignPost = {x = 263, z = 129, tip = "V‚n PhiÍu PhiÍu "}
...
function x210214_OnAccept( sceneId, selfId )
	...
	Msg2Player(  sceneId, selfId,"#YNhßn nhiÆm v¯#W: tr‚n th˙ th— nh§t",MSG2PLAYER_PARA )
...
function x210214_OnSubmit( sceneId, selfId, targetId, selectRadioId )
	if x210214_CheckSubmit( sceneId, selfId, selectRadioId ) == 1 then
		...
		Msg2Player(  sceneId, selfId,"#YHo‡n t§t nhiÆm v¯#W: tr‚n th˙ th— nh§t",MSG2PLAYER_PARA )
