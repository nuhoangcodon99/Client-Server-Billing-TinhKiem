...
x210225_g_MissionTarget="ó #GhÎm Ng˜c NhÓ phÌa –Ùng Nam th‡nh –’i L˝#W tÏm #R–o‡n DiÍn Kh·nh #W#{_INFOAIM215,284,2, –o‡n DiÍn Kh·nh}. "
x210225_g_MissionComplete="#{event_dali_0036}"
x210225_g_MoneyBonus=72
x210225_g_SignPost = {x = 215, z = 284, tip = "–o‡n DiÍn Kh·nh "}
...
function x210225_OnSubmit( sceneId, selfId, targetId, selectRadioId )
	if x210225_CheckSubmit( sceneId, selfId, selectRadioId ) == 1 then
		...
		Msg2Player(  sceneId, selfId,"#YHo‡n t§t nhiÆm v¯#W: –o‡n DiÍn Kh·nh",MSG2PLAYER_PARA )
