...
function x005116_UpDateMonster( sceneId, nIndex, nGroupId )
	...
	if nIndex == 5   then
		...
		local str = "#PThüy t£c hoành hành giang h°, gi¶ ðây #{_BOSS14} th¯ng lînh thuµc hÕ cüa mình ðang xu¤t hi®n · #GKính H° #P! Xin các v¸ anh hùng hãy nhanh chóng ði tiêu di®t!"
