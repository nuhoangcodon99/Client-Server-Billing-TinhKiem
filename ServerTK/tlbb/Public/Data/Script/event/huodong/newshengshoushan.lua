...
--ÐèÒªË¢³öµÄ10Ö»À×÷ëNPC£¬10Ö»³û·ïNPCµÄÊý¾Ý±í....
x808120_g_BossData = {
	...
	{ ID=13288, AIType=3, AIScriptID=-1, ScriptID=808121, NeedCreateNum=10, LifeTime=29*60*1000, Title = "Thiên Niên KÏ Thú"},   ----À×÷ë
	{ ID=13289, AIType=3, AIScriptID=-1, ScriptID=808121, NeedCreateNum=10, LifeTime=29*60*1000, Title = "Thiên Niên KÏ Thú" },
}
...
--Ë¢³ö¹ÖµÄNPC×ø±êËæ»ú×ø±ê---µÚ¶þÅú  19:00 and 21:45
