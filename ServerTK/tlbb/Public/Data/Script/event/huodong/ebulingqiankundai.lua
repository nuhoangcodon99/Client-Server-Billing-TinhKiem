...
x808129_g_QianKunDaiBuLingLv1 = 30008059 --一级乾坤袋
x808129_g_QianKunDaiBuLing = 30504118  --补领的70级乾坤袋
...
function x808129_OnDefaultEvent( sceneId, selfId, targetId )
	...
	elseif id == 2 then
		...
		-- 补给乾坤袋,小于70级的给一级袋,大于等于70级的给一个70级特殊袋
		local nBagIndex = -1
...
function x808129_OnEnumerate( sceneId, selfId, targetId )
	...
	-- "补领"
  AddNumText(sceneId, x808129_g_ScriptId, "#{XRLB_090417_01}", 6, 1 ) --补领江湖乾坤袋
end
