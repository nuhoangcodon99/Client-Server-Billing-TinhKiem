...
function x808007_OnLockUI( sceneId, selfId )
	...
	BeginEvent( sceneId )
		...
		if LuaFnIsPasswordSetup( sceneId, selfId, 0 ) ~= 1 then
			AddNumText( sceneId, x808007_g_ScriptId, "Thiªt l§p m§t mã", 2, x808007_g_Key["lck_set"] )
		else
			AddNumText( sceneId, x808007_g_ScriptId, "Ğ±i m§t mã", 2, x808007_g_Key["lck_res"] )
		end
