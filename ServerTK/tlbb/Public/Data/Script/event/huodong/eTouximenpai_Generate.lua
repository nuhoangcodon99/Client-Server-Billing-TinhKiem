			...
			for i, v in x808015_g_scenePosInfoList do
				if v.sceneId == sceneId then
				    ...
				    local j=1
						...
						local NotifyMsg = "@*;SrvMsg;SCA:#P"..v.sceneLeader.."#P: Ta #Y"..v.sceneName.."#P ðµt nhiên b¸ mµt t¯p #GGiang h° ti¬u tØ#P ðánh lén, ð® tØ môn hÕ các n½i mau v« môn phái quét sÕch kë ð¸ch"
