...
function x125022_OnActivateEffectOnce( sceneId, selfId, activatorId )
	...
	if bDelOk == 1  then
		...
		if nBoxId > -1  then
			...
			local str = format("#YVu CØu Liên#P hét l¾n : HÞi anh hùng thiên hÕ ! Ðã có #{_INFOUSR%s}#P ðoÕt ðßþc Võ Lâm Minh Chü Bäo Sß½ng ! M÷i ngß¶i vào lúc #Y% gi¶ 45 phút #Phãy lÕi ðªn#G Phong Thi«n Ðài #Ptranh ðoÕt Võ Lâm Minh Chü !",GetName(sceneId,activatorId),nCurHour)
