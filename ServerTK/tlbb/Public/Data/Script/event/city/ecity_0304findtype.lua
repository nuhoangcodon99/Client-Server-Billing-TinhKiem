...
x600016_g_MissionTarget = "    T× %n cß¾p v« %s cái %i. "						--ÈÎÎñÄ¿±ê
...
x600016_g_ItemCountIdx = x600016_g_StrForePart + 1									-- ÈÎÎñÎïÆ·ÊýÁ¿µÄ´æ´¢Î»ÖÃ
x600016_g_ItemIdx = x600016_g_StrForePart + 2										-- ÈÎÎñÎïÆ·µÄ´æ´¢Î»ÖÃ
...
--ÈÎÎñÈë¿Úº¯Êý
--**********************************
function x600016_OnDefaultEvent( sceneId, selfId, targetId )	--µã»÷¸ÃÈÎÎñºóÖ´ÐÐ´Ë½Å±¾
	if GetName( sceneId, targetId ) ~= x600016_g_Name then		--ÅÐ¶Ï¸ÃnpcÊÇ·ñÊÇ¶ÔÓ¦ÈÎÎñµÄnpc
		return
	end
...
--É±ËÀ¹ÖÎï»òÍæ¼Ò
--**********************************
function x600016_OnKillObject( sceneId, selfId, objdataId, objId )	--²ÎÊýÒâË¼£º³¡¾°ºÅ¡¢Íæ¼ÒobjId¡¢¹ÖÎï±íÎ»ÖÃºÅ¡¢¹ÖÎïobjId
	...
	for i = 0, allOwnersCount - 1 do
		...
		if IsHaveMission( sceneId, curOwner, x600016_g_MissionId ) > 0 and
		   GetScriptIDByMissionID( sceneId, curOwner, x600016_g_MissionId ) == x600016_g_ScriptId then		--Èç¹ûÕâ¸öÈËÓµÓÐÈÎÎñ
