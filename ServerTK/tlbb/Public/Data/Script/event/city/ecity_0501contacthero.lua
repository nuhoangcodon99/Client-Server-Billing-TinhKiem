...
x600024_g_MissionTarget = "    Sau ğó ğßa tin cho %n. "							--ÈÎÎñÄ¿±ê
...
--ÈÎÎñÈë¿Úº¯Êı
--**********************************
function x600024_OnDefaultEvent( sceneId, selfId, targetId )	--µã»÷¸ÃÈÎÎñºóÖ´ĞĞ´Ë½Å±¾
	if GetName( sceneId, targetId ) ~= x600024_g_Name then		--ÅĞ¶Ï¸ÃnpcÊÇ·ñÊÇ¶ÔÓ¦ÈÎÎñµÄnpc
		return
	end
...
function x600024_OnAccept( sceneId, selfId, targetId )
	...
	strNpcScene = gsub( strNpcScene, "Ğích", "" )
...
--É±ËÀ¹ÖÎï»òÍæ¼Ò
--**********************************
function x600024_OnKillObject( sceneId, selfId, objdataId, objId )	--²ÎÊıÒâË¼£º³¡¾°ºÅ¡¢Íæ¼ÒobjId¡¢¹ÖÎï±íÎ»ÖÃºÅ¡¢¹ÖÎïobjId
end
...
function x600024_OnLockedTarget( sceneId, selfId, objId )
	...
	local misIndex = GetMissionIndexByID( sceneId, selfId, x600024_g_MissionId )		--µÃµ½ÈÎÎñÔÚ20¸öÈÎÎñÖĞµÄĞòÁĞºÅ
