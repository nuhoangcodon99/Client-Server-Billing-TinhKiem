...
function x805041_GenObj( sceneId, PosList )     --Éú³ÉÉ½¹í¡¢É½Ñý
    local PosIndex = {}
    local IndexList = {}
...
function x805041_OnTimer( sceneId, actId, uTime )
	...
	then
		...
		AddGlobalCountNews( sceneId, "@*;SrvMsg;SCA:#P"..cityDefaultName.." c¤p báo ! Bang Hµi thành th¸ "..cityName.." ðµt nhiên xu¤t hi®n mµt nhóm ác quï, s½n th¥n, các huynh ð® tÑc t¯c h°i Bang ð¬ tr× ác!" )
