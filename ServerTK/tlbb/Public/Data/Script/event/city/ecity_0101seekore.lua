...
x600003_g_MissionTarget = "    Tìm kiªm %i, ðßa cho bang hµi thành th¸ Mã ºng Hùng (65, 55). "	--ÈÎÎñÄ¿±ê
...
x600003_g_Offset = 6														-- Suppose to 6, ±íÀïµÚ¼¸¸öÎïÆ·ÁÐµÄÆ«ÒÆÁ¿
...
--ÈÎÎñÈë¿Úº¯Êý
--**********************************
function x600003_OnDefaultEvent( sceneId, selfId, targetId )	--µã»÷¸ÃÈÎÎñºóÖ´ÐÐ´Ë½Å±¾
	if GetName( sceneId, targetId ) ~= x600003_g_Name then		--ÅÐ¶Ï¸ÃnpcÊÇ·ñÊÇ¶ÔÓ¦ÈÎÎñµÄnpc
		return
	end
...
--**********************************
--¸ù¾ÝÏàÓ¦½¨ÖþµÈ¼¶µÃµ½¶ÔÓ¦MissionItem_HashTable.txtÖÐµÄµ¥ÔªË÷Òý
--**********************************
...
--É±ËÀ¹ÖÎï»òÍæ¼Ò
--**********************************
function x600003_OnKillObject( sceneId, selfId, objdataId, objId )	--²ÎÊýÒâË¼£º³¡¾°ºÅ¡¢Íæ¼ÒobjId¡¢¹ÖÎï±íÎ»ÖÃºÅ¡¢¹ÖÎïobjId
end
