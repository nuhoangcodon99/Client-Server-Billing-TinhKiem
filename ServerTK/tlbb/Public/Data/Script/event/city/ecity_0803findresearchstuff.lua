...
x600043_g_MissionParam_Phase		= 2	--2 ½×¶ÎºÅ ´ËºÅÓÃÓÚÇø·Öµ±Ç°ÈÎÎñUIµÄÃèÊöÐÅÏ¢
...
x600043_g_MissionParam_IsCarrier= 6	--6 ÊÇ·ñÓÐËÍÐÅÈÎÎñ
...
x600043_g_MissionComplete	= "    R¤t t¯t r¤t t¯t, tiªn ðµ nghiên cÑu tång nhanh không ít. "--Íê³ÉÈÎÎñnpcËµ»°µÄ»°
...
x600043_g_ItemOffset			= 31	--±íÀïµÚ¼¸¸öÎïÆ·ÁÐµÄÆ«ÒÆÁ¿
...
function x600043_OnAccept( sceneId, selfId, targetId )
	...
	if IsHaveMission( sceneId, selfId, x600043_g_MissionId ) == 0 then
		...
		--sceneId, selfId, misId(ÈÎÎñ±àºÅ), scriptId, k(ÊÇ·ñ»Øµ÷x600043_OnKillObject), e(ÊÇ·ñ»Øµ÷OnEnterArea), i(ÊÇ·ñ»Øµ÷OnItemChange)
...
--	SetMissionEvent( sceneId, selfId, x600043_g_MissionId, 4 )
		...
		BeginEvent( sceneId )
			...
			AddText( sceneId, "#rCác hÕ ðã nh§n " .. x600043_g_MissionName )
		EndEvent( sceneId )
