...
x600041_g_MissionParam_Phase		= 2	--2 ½×¶ÎºÅ ´ËºÅÓÃÓÚÇø·Öµ±Ç°ÈÎÎñUIµÄÃèÊöÐÅÏ¢
...
x600041_g_MissionParam_IsCarrier= 6	--6 ÊÇ·ñÓÐËÍÐÅÈÎÎñ
...
x600041_g_MissionComplete	= "    R¤t t¯t r¤t t¯t, tiªn ðµ nghiên cÑu tång nhanh không ít. "--Íê³ÉÈÎÎñnpcËµ»°µÄ»°
...
x600041_g_ItemOffset			= 39	--±íÀïµÚ¼¸¸öÎïÆ·ÁÐµÄÆ«ÒÆÁ¿
x600041_g_NPCOffset				= 38	--±íÀïµÚ¼¸ÁÐ NPC µÄÆ«ÒÆÁ¿
x600041_g_NPCOffsetEx			= 259 --±íÀïµÚ¼¸ÁÐ NPC µÄÆ«ÒÆÁ¿À©³ä modi:lby20071126
x600041_g_MonsterOffset		= 43	--±íÀïµÚ¼¸ÁÐ Monster µÄÆ«ÒÆÁ¿

--½×¶ÎÈÎÎñ
--µôÂä¹æÔò£º10%¼¸ÂÊµôÂäÈÎÎñÎïÆ·£»ÔÚµôÂäµÄ¼¸ÂÊÖÐ£¬1³ÉÖ±½Ó´ò³öÑÐ¾¿ÒªÊõ£¬Áí9³É»á´ò³ö"ÊÕÌõÊéÐÅ"
x600041_g_PhaseKey				= {}
x600041_g_PhaseKey["mal"]	= 1		--ÊÕÌõÊéÐÅ£ºµôÂäÊéÐÅ£¬Ë¢ÐÂÈÎÎñÃèÊö£¬µ½NPC´¦×·»¹ËùÐèÎïÆ·
x600041_g_PhaseKey["fnd"]	= 2		--Ñ°ÕÒÑÐ¾¿ÒªÊõ£ºÖ±½ÓµôÂäËùÐèÎïÆ·
...
function x600041_OnAccept( sceneId, selfId, targetId )
	...
	if IsHaveMission( sceneId, selfId, x600041_g_MissionId ) == 0 then
		...
		--ÐÞ¸ÄÍæ¼ÒÉíÉÏmisId±àºÅµÄÈÎÎñÏàÓ¦ÊÂ¼þ
		...
		--ÊÇ·ñÓÐËÍÐÅÈÎÎñ
		--Èç¹ûÊÇ£¬¹ÖÎï»á²»¶ÏµôÂä"ÊÕÌõÊéÐÅ"£¬´ËÊ±ÒªÇóÍæ¼Ò±ØÐëÍê³ÉÒ»´Î¸ÃÈÎÎñ
		if random( 10 ) <= 1 then
		...
		BeginEvent( sceneId )
			...
			AddText( sceneId, "#rCác hÕ ðã nh§n " .. x600041_g_MissionName )
		EndEvent( sceneId )
...
function x600041_OnKillObject( sceneId, selfId, objdataId, objId )
	...
	--È¡µÃÕâ¸ö¹ÖÎïËÀºóÓµÓÐ·ÖÅäÈ¨µÄÈËÊý
