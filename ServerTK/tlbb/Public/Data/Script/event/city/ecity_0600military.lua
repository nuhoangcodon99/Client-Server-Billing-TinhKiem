...
x600030_g_MissionTarget = "  Hoàn thành nhi®m vø Võ ĞÕi Uy"			--ÈÎÎñÄ¿±ê
x600030_g_ContinueInfo = "  Nhi®m vø cüa các hÕ vçn chßa hoàn thành à?"	--Î´Íê³ÉÈÎÎñµÄnpc¶Ô»°
x600030_g_MissionComplete = "  Làm t¯t l¡m, cám ½n các hÕ r¤t nhi«u. "				--Íê³ÉÈÎÎñnpcËµµÄ»°
...
-- ÈÎÎñ½±Àø
x600030_g_ItemAwardIndexOffset = 28						-- ÎïÆ·½±ÀøËùÔÚ±í¸ñÖĞµÄÁĞÆ«ÒÆ, need to modify
x600030_g_MissionRound = MD_CITY_MILITARY_ROUND			-- ³ÇÊĞÄÚÕş¹ú·ÀÈÎÎñ
x600030_g_MissionAbandonTime = MD_CITY_MILITARY_TIME		-- ³ÇÊĞÄÚÕş¹ú·ÀÈÎÎñ·ÅÆúÈÎÎñµÄÊ±¼ä
...
--ÈÎÎñÈë¿Úº¯Êı
--**********************************
function x600030_OnDefaultEvent( sceneId, selfId, targetId )	--µã»÷¸ÃÈÎÎñºóÖ´ĞĞ´Ë½Å±¾

	if GetName( sceneId, targetId ) ~= x600030_g_Name then		--ÅĞ¶Ï¸ÃnpcÊÇ·ñÊÇ¶ÔÓ¦ÈÎÎñµÄnpc
		return
	end
