...
x600011_g_MissionTarget = "    T× %n nh§n v« %s cái %i. "					--ÈÎÎñÄ¿±ê
...
x600011_g_ItemCountIdx = x600011_g_StrForePart + 1									-- ÈÎÎñÎïÆ·ÊýÁ¿µÄ´æ´¢Î»ÖÃ
x600011_g_ItemIdx = x600011_g_StrForePart + 2										-- ÈÎÎñÎïÆ·µÄ´æ´¢Î»ÖÃ
...
--ÈÎÎñÈë¿Úº¯Êý
--**********************************
function x600011_OnDefaultEvent( sceneId, selfId, targetId )	--µã»÷¸ÃÈÎÎñºóÖ´ÐÐ´Ë½Å±¾
	if GetName( sceneId, targetId ) ~= x600011_g_Name then		--ÅÐ¶Ï¸ÃnpcÊÇ·ñÊÇ¶ÔÓ¦ÈÎÎñµÄnpc
		return
	end
...
--É±ËÀ¹ÖÎï»òÍæ¼Ò
--**********************************
function x600011_OnKillObject( sceneId, selfId, objdataId, objId )	--²ÎÊýÒâË¼£º³¡¾°ºÅ¡¢Íæ¼ÒobjId¡¢¹ÖÎï±íÎ»ÖÃºÅ¡¢¹ÖÎïobjId
	...
	for i = 0, allOwnersCount - 1 do
		...
		if IsHaveMission( sceneId, curOwner, x600011_g_MissionId ) > 0 and
		   GetScriptIDByMissionID( sceneId, curOwner, x600011_g_MissionId ) == x600011_g_ScriptId then		--Èç¹ûÕâ¸öÈËÓµÓÐÈÎÎñ
