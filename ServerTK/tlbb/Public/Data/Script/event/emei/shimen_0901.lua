...
x226901_g_MissionInfo="Giªt hªt toàn bµ quái v§t, 1 con cûng không tha!"  --ÈÎÎñÃèÊö
x226901_g_MissionTarget="Giªt hªt toàn bµ quái v§t. "	--ÈÎÎñÄ¿±ê
...
function x226901_OnSubmit( sceneId, selfId, targetId, selectRadioId )
	if x226901_CheckSubmit( sceneId, selfId, selectRadioId )>0 then		--ÒÑ¾­Íê³ÉÈÎÎñÁË
		...
		BeginEvent(sceneId)
			strText = "Ğánh th¡ng tr§n ğào hoa r°i, nhi®m vø hoàn thành!"
