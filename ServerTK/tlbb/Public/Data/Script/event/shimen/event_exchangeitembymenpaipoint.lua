...
x229009_g_MaleTitleInfo = {
	...
	{tlvl=2, mpp=1000, slt="Khôi Y Hµ Pháp ", mjt="Th¸ Hoä Hi®p Sî ", gbt="Thanh Liên Ð® TØ ", wdt="Thanh Minh Cß Sî ", emt="Thanh Phong Cß Sî ", xxt="Hành Ôn Lang Quân ", tlt="Tàng Kinh Hi®p Sî ", tst="Dß½ng Thiên Bµ Chúng ", xyt="Phù C¥m Cß Sî "},
	{tlvl=3, mpp=2500, slt="Kim Thân La Hán ", mjt="Hµ Giáo Pháp Vß½ng ", gbt="Huy«n Võ Trß·ng Lão ", wdt="Vô Vi Chân Nhân ", emt="Ng÷c Long Hi®p Sî ", xxt="Thúc M®nh Phán Quan ", tlt="Sùng Thánh Thiên Sß ", tst="Thiên S½n Thß½ng ¿ng ", xyt="LÕc Th¥n Hi®p Sî "},
	{tlvl=4, mpp=5000, slt="Ð¸a TÕng B° Tát ", mjt="Minh Giáo Th¥n SÑ ", gbt="Chß·ng Bang Long Ð¥u ", wdt="Võ Ðang Thiên Tôn ", emt="Nga My Tiên Nhân ", xxt="Ðµc Thü Y Tiên ", tlt="Thiên Nam Long Vß½ng ", tst="H²n Nguyên S½n Th¥n ", xyt="Tiêu Dao Long Th¥n "},
}
--Å®	
	...
	for i, v in x229009_g_menpainpc_table do
		if v.name == GetName(sceneId, targetId) then
			if v.menpaiid == GetMenPai(sceneId, selfId) then
				...
				local str = "Ngß½i không phäi là ð® tØ cüa môn phái này, ta chï phøc vø cho ð® tØ môn phái"
				BeginEvent(sceneId)
					AddText(sceneId, str)
				EndEvent()
