...
x805026_g_MissionTarget="Cho ğÕi t±ng quän bang hµi 5 ğ°ng ti«n"

x805026_g_MissionContinue="Các hÕ ğã có ğü 5 ğ°ng ti«n chßa?"

x805026_g_MissionComplete="  », làm khá l¡m. Xem ra các hÕ có nhi«u ti«n l¡m ğ¤y"
...
function x805026_OnAccept( sceneId, selfId )
	...
	Msg2Player(  sceneId, selfId,"#Y½ÓÊÜÈÎ„Õ£ºÉı¼‰ÑĞ¾¿",MSG2PLAYER_PARA )
...
function x805026_OnSubmit( sceneId, selfId, targetId, selectRadioId )
	...
	if x805026_CheckSubmit( sceneId, selfId, selectRadioId ) == 1 then
			...
			if ret > 0 then
				...
				Msg2Player(  sceneId, selfId,"#YHoàn t¤t nhi®m vø#W: thång c¤p nghiên cÑu",MSG2PLAYER_PARA )
