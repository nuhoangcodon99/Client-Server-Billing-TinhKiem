...
--¹Ø±ÕÕäÊÞÉáÀû×Ó¼°°ïÖú£¬Ìí¼Ó¼ÄÁ·ÕäÊÞ£¬ by zhangqiang 2009.6.19
		AddNumText( sceneId, x805019_g_scriptId, "Luy®n chª trân thú xá lþi tØ", 6, 2 ) --hd edit
		AddNumText( sceneId, x805019_g_scriptId, "Quan vu trân thú khoái t¯c thång c¤p", 11, 3 ) --hd edit
